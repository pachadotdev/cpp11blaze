...
//! upgrade_val is used to ensure an operation such as multiplication is possible between
//! two types. values are upgraded only where necessary.
...
struct upgrade_val {
  ...
  arma_inline static typename promote_type<T1, T2>::result apply(const T1 x) {
    typedef typename promote_type<T1, T2>::result out_type;
    return out_type(x);
  }

  arma_inline static typename promote_type<T1, T2>::result apply(const T2 x) {
    typedef typename promote_type<T1, T2>::result out_type;
    return out_type(x);
  }
};
...
struct upgrade_val<std::complex<float>, double> {
  ...
  arma_inline static const std::complex<double> apply(const std::complex<float>& x) {
...
struct upgrade_val<std::complex<float>, std::complex<double> > {
  ...
  arma_inline static const std::complex<double>& apply(const std::complex<double>& x) {
    return x;
  }
};
