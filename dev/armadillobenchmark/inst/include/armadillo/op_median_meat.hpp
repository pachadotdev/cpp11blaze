...
inline void op_median::apply_noalias(Mat<eT>& out, const Mat<eT>& X, const uword dim,
...
template <typename T1>
inline typename T1::elem_type op_median::median_vec(
...
template <typename T>
inline void op_median::direct_cx_median_index(uword& out_index1, uword& out_index2,
