...
//// You will need to link your programs directly with -lopenblas -llapack instead of
///-larmadillo
...
#pragma message( \
    "WARNING: support for ARMA_DONT_USE_CXX11_MUTEX is deprecated and will be removed;")
...
#undef ARMA_OPTIMISE_BAND
    ...
    defined(ARMA_DONT_OPTIMISE_SOLVE_SYMPD)
...
// defined, ARMA_AUX_LIBS lists the libraries required by Armadillo on this system, and
