  ...
  {                                                                              \
    ...
    for (; it != it_end; ++it) {                                                 \
      ...
      if ((cur_pos - last_pos) > offset) {                                       \
        arrayops::inplace_set((tmp.memptr() + last_pos + offset), zero_comp_val, \
...
inline void spop_rel_lt_pre::apply(SpMat<uword>& out,
                                   const mtSpOp<uword, T1, spop_rel_lt_pre>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_rel_gt_pre::apply(SpMat<uword>& out,
                                   const mtSpOp<uword, T1, spop_rel_gt_pre>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_rel_lteq_pre::apply(SpMat<uword>& out,
                                     const mtSpOp<uword, T1, spop_rel_lteq_pre>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_rel_gteq_pre::apply(SpMat<uword>& out,
                                     const mtSpOp<uword, T1, spop_rel_gteq_pre>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_rel_lt_post::apply(SpMat<uword>& out,
                                    const mtSpOp<uword, T1, spop_rel_lt_post>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_rel_gt_post::apply(SpMat<uword>& out,
                                    const mtSpOp<uword, T1, spop_rel_gt_post>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_rel_lteq_post::apply(SpMat<uword>& out,
                                      const mtSpOp<uword, T1, spop_rel_lteq_post>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_rel_gteq_post::apply(SpMat<uword>& out,
                                      const mtSpOp<uword, T1, spop_rel_gteq_post>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_rel_eq::apply(SpMat<uword>& out,
                               const mtSpOp<uword, T1, spop_rel_eq>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_rel_noteq::apply(SpMat<uword>& out,
                                  const mtSpOp<uword, T1, spop_rel_noteq>& X) {
  arma_debug_sigprint();
