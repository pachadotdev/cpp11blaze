...
inline bool SizeCube::operator==(const SizeCube& s) const {
  if (n_rows != s.n_rows) {
    return false;
  }
...
inline SizeCube SizeCube::operator+(const SizeCube& s) const {
...
inline SizeCube SizeCube::operator+(const uword val) const {
