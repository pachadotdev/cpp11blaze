...
arma_warn_unused inline uvec trimatu_ind(const SizeMat& s, const sword k = 0) {
  arma_debug_sigprint();
  ...
  arma_conform_check_bounds(((row_offset > 0) && (row_offset >= n_rows)) ||
                            ...
                            "trimatu_ind(): requested diagonal is out of bounds");
...
arma_warn_unused inline uvec trimatl_ind(const SizeMat& s, const sword k = 0) {
  arma_debug_sigprint();
  ...
  arma_conform_check_bounds(((row_offset > 0) && (row_offset >= n_rows)) ||
                                ((col_offset > 0) && (col_offset >= n_cols)),
                            "trimatl_ind(): requested diagonal is out of bounds");
