...
//! (ie. where the submatrix starts and ends as well as a reference/pointer to the
//! original matrix),
...
class subview : public Base<eT, subview<eT> > {
 ...
 protected:
  arma_inline subview(const Mat<eT>& in_m, const uword in_row1, const uword in_col1,
 ...
 public:
  ...
  inline subview<eT> submat(const uword in_row1, const uword in_col1, const uword in_row2,
                            const uword in_col2);
  inline const subview<eT> submat(const uword in_row1, const uword in_col1,
  ...
  class const_iterator {
   public:
    ...
    inline const_iterator(const subview<eT>& in_sv, const uword in_row,
                          const uword in_col);
  ...
  class const_row_iterator {
   public:
    ...
    inline const_row_iterator(const subview<eT>& in_sv, const uword in_row,
                              const uword in_col);
...
class subview_col : public subview<eT> {
 ...
 protected:
  ...
  inline subview_col(const Mat<eT>& in_m, const uword in_col, const uword in_row1,
...
class subview_cols : public subview<eT> {
 public:
  ...
  arma_warn_unused arma_inline const Op<subview_cols<eT>, op_vectorise_col> as_col()
      const;
...
class subview_row : public subview<eT> {
 ...
 protected:
  ...
  inline subview_row(const Mat<eT>& in_m, const uword in_row, const uword in_col1,
