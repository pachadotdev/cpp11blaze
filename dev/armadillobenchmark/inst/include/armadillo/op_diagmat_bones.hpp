...
class op_diagmat : public traits_op_default {
 public:
  ...
  template <typename T1, typename T2>
  inline static void apply_times(
      Mat<typename T1::elem_type>& out, const T1& X, const T2& Y,
...
class op_diagmat2 : public traits_op_default {
 public:
  template <typename T1>
  inline static void apply(Mat<typename T1::elem_type>& out,
