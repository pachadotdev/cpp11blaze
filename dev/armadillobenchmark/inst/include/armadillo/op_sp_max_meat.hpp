...
inline void op_sp_max::apply(
    Mat<typename T1::elem_type>& out,
    const mtSpReduceOp<typename T1::elem_type, T1, op_sp_max>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void op_sp_max::apply_proxy(
...
template <typename T1>
inline typename T1::elem_type op_sp_max::vector_max(
...
template <typename T1>
inline typename arma_not_cx<typename T1::elem_type>::result op_sp_max::max(
...
template <typename T1>
inline typename arma_not_cx<typename T1::elem_type>::result op_sp_max::max_with_index(
    const SpProxy<T1>& P, uword& index_of_max_val) {
  arma_debug_sigprint();
...
template <typename T1>
inline typename arma_cx_only<typename T1::elem_type>::result op_sp_max::max(
    const SpBase<typename T1::elem_type, T1>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline typename arma_cx_only<typename T1::elem_type>::result op_sp_max::max_with_index(
    const SpProxy<T1>& P, uword& index_of_max_val) {
  arma_debug_sigprint();
