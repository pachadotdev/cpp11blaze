...
inline bool SizeMat::operator==(const SizeMat& s) const {
  if (n_rows != s.n_rows) {
    return false;
  }
...
inline SizeMat SizeMat::operator+(const SizeMat& s) const {
...
inline SizeMat SizeMat::operator+(const uword val) const {
