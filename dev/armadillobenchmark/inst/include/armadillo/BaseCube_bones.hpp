...
struct BaseCube_eval_expr {
  arma_warn_unused inline Cube<elem_type> eval()
...
struct BaseCube
  ...
  arma_warn_unused inline const CubeToMatOp<derived, op_row_as_mat> row_as_mat(
      const uword in_row) const;
  arma_warn_unused inline const CubeToMatOp<derived, op_col_as_mat> col_as_mat(
