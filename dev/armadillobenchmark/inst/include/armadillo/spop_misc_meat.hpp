...
inline void spop_scalar_times::apply(SpMat<typename T1::elem_type>& out,
                                     const SpOp<T1, spop_scalar_times>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_cx_scalar_times::apply(
    SpMat<std::complex<typename T1::pod_type> >& out,
    const mtSpOp<std::complex<typename T1::pod_type>, T1, spop_cx_scalar_times>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_square::apply(SpMat<typename T1::elem_type>& out,
                               const SpOp<T1, spop_square>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_sqrt::apply(SpMat<typename T1::elem_type>& out,
                             const SpOp<T1, spop_sqrt>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_cbrt::apply(SpMat<typename T1::elem_type>& out,
                             const SpOp<T1, spop_cbrt>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_abs::apply(SpMat<typename T1::elem_type>& out,
                            const SpOp<T1, spop_abs>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_cx_abs::apply(SpMat<typename T1::pod_type>& out,
                               const mtSpOp<typename T1::pod_type, T1, spop_cx_abs>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_arg::apply(SpMat<typename T1::elem_type>& out,
                            const SpOp<T1, spop_arg>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_cx_arg::apply(SpMat<typename T1::pod_type>& out,
                               const mtSpOp<typename T1::pod_type, T1, spop_cx_arg>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_real::apply(SpMat<typename T1::pod_type>& out,
                             const mtSpOp<typename T1::pod_type, T1, spop_real>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_imag::apply(SpMat<typename T1::pod_type>& out,
                             const mtSpOp<typename T1::pod_type, T1, spop_imag>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_conj::apply(SpMat<typename T1::elem_type>& out,
                             const SpOp<T1, spop_conj>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_repelem::apply(SpMat<typename T1::elem_type>& out,
                                const SpOp<T1, spop_repelem>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_reshape::apply(SpMat<typename T1::elem_type>& out,
                                const SpOp<T1, spop_reshape>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_resize::apply(SpMat<typename T1::elem_type>& out,
                               const SpOp<T1, spop_resize>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_floor::apply(SpMat<typename T1::elem_type>& out,
                              const SpOp<T1, spop_floor>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_ceil::apply(SpMat<typename T1::elem_type>& out,
                             const SpOp<T1, spop_ceil>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_round::apply(SpMat<typename T1::elem_type>& out,
                              const SpOp<T1, spop_round>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_trunc::apply(SpMat<typename T1::elem_type>& out,
                              const SpOp<T1, spop_trunc>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_sign::apply(SpMat<typename T1::elem_type>& out,
                             const SpOp<T1, spop_sign>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_flipud::apply(SpMat<typename T1::elem_type>& out,
                               const SpOp<T1, spop_flipud>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void spop_fliplr::apply(SpMat<typename T1::elem_type>& out,
                               const SpOp<T1, spop_fliplr>& in) {
  arma_debug_sigprint();
