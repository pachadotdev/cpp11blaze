...
class spop_vectorise_col : public traits_op_col {
 public:
  ...
  template <typename T1>
  inline static void apply_direct(SpMat<typename T1::elem_type>& out, const T1& expr);
};

class spop_vectorise_row : public traits_op_row {
 public:
  template <typename T1>
  inline static void apply(SpMat<typename T1::elem_type>& out,
...
class spop_vectorise_all : public traits_op_xvec {
 public:
  template <typename T1>
  inline static void apply(SpMat<typename T1::elem_type>& out,
