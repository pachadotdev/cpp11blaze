...
class op_mean : public traits_op_xvec {
 public:
  // dense matrices
  ...
  template <typename T1>
  inline static void apply_noalias_unwrap(Mat<typename T1::elem_type>& out,
                                          const Proxy<T1>& P, const uword dim);

  template <typename T1>
  inline static void apply_noalias_proxy(Mat<typename T1::elem_type>& out,
                                         const Proxy<T1>& P, const uword dim);
  ...
  template <typename T1>
  inline static void apply_noalias_unwrap(Cube<typename T1::elem_type>& out,
                                          const ProxyCube<T1>& P, const uword dim);

  template <typename T1>
  inline static void apply_noalias_proxy(Cube<typename T1::elem_type>& out,
                                         const ProxyCube<T1>& P, const uword dim);
