...
class MapMat {
 ...
 public:
  ...
  arma_warn_unused arma_inline MapMat_val<eT> operator()(const uword in_row,
                                                         const uword in_col);
...
class SpMat_MapMat_val {
 private:
  ...
  inline SpMat_MapMat_val(SpMat<eT>& in_s_parent, MapMat<eT>& in_m_parent,
...
class SpSubview_MapMat_val : public SpMat_MapMat_val<eT> {
 private:
  arma_inline SpSubview_MapMat_val(SpSubview<eT>& in_sv_parent, MapMat<eT>& in_m_parent,
                                   const uword in_row, const uword in_col);
