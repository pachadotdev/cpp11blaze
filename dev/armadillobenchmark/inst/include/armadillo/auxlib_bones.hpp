...
class auxlib {
 public:
  ...
  template <typename eT>
  inline static bool inv_tr_rcond(Mat<eT>& A,
                                  typename get_pod_type<eT>::result& out_rcond,
                                  const uword layout);
  ...
  template <typename T>
  inline static bool inv_sympd_rcond(Mat<std::complex<T> >& A, bool& out_sympd_state,
                                     T& out_rcond);
  ...
  template <typename eT>
  inline static bool log_det(eT& out_val, typename get_pod_type<eT>::result& out_sign,
                             Mat<eT>& A);

  template <typename eT>
  inline static bool log_det_sympd(typename get_pod_type<eT>::result& out_val,
                                   Mat<eT>& A);
  ...
  inline static bool lu(Mat<eT>& L, Mat<eT>& U, podarray<blas_int>& ipiv,
                        const Base<eT, T1>& X);
  ...
  template <typename T1>
  inline static bool eig_gen_balance(Mat<std::complex<typename T1::pod_type> >& vals,
                                     Mat<std::complex<typename T1::pod_type> >& vecs,
                                     const bool vecs_on,
                                     const Base<typename T1::pod_type, T1>& expr);

  template <typename T1>
  inline static bool eig_gen_balance(
  ...
  template <typename T1>
  inline static bool eig_gen_twosided(Mat<std::complex<typename T1::pod_type> >& vals,
                                      Mat<std::complex<typename T1::pod_type> >& lvecs,
                                      Mat<std::complex<typename T1::pod_type> >& rvecs,
                                      const Base<typename T1::pod_type, T1>& expr);

  template <typename T1>
  inline static bool eig_gen_twosided(
      Mat<std::complex<typename T1::pod_type> >& vals,
      Mat<std::complex<typename T1::pod_type> >& lvecs,
      Mat<std::complex<typename T1::pod_type> >& rvecs,
      const Base<std::complex<typename T1::pod_type>, T1>& expr);
  ...
  template <typename T1>
  inline static bool eig_gen_twosided_balance(
      Mat<std::complex<typename T1::pod_type> >& vals,
      Mat<std::complex<typename T1::pod_type> >& lvecs,
      Mat<std::complex<typename T1::pod_type> >& rvecs,
      const Base<typename T1::pod_type, T1>& expr);
  ...
  template <typename T1, typename T2>
  inline static bool eig_pair_twosided(Mat<std::complex<typename T1::pod_type> >& vals,
                                       Mat<std::complex<typename T1::pod_type> >& lvecs,
                                       Mat<std::complex<typename T1::pod_type> >& rvecs,
                                       const Base<typename T1::pod_type, T1>& A_expr,
                                       const Base<typename T1::pod_type, T2>& B_expr);
  ...
  template <typename T1, typename T2>
  inline static bool eig_pair_twosided(
      Mat<std::complex<typename T1::pod_type> >& vals,
      Mat<std::complex<typename T1::pod_type> >& lvecs,
      Mat<std::complex<typename T1::pod_type> >& rvecs,
      const Base<std::complex<typename T1::pod_type>, T1>& A_expr,
  ...
  template <typename T>
  inline static bool eig_sym(Col<T>& eigval, Mat<std::complex<T> >& eigvec,
  ...
  template <typename T>
  inline static bool eig_sym_dc(Col<T>& eigval, Mat<std::complex<T> >& eigvec,
                                const Mat<std::complex<T> >& X);
  ...
  template <typename T>
  inline static bool chol_band(Mat<std::complex<T> >& X, const uword KD,
                               const uword layout);
  ...
  template <typename eT, typename T1>
  inline static bool qr_pivot(Mat<eT>& Q, Mat<eT>& R, Mat<uword>& P,
                              const Base<eT, T1>& X);

  template <typename T, typename T1>
  inline static bool qr_pivot(Mat<std::complex<T> >& Q, Mat<std::complex<T> >& R,
  ...
  template <typename T>
  inline static bool svd(Mat<std::complex<T> >& U, Col<T>& S, Mat<std::complex<T> >& V,
                         Mat<std::complex<T> >& A);

  template <typename eT>
  inline static bool svd_econ(Mat<eT>& U, Col<eT>& S, Mat<eT>& V, Mat<eT>& A,
                              const char mode);

  template <typename T>
  inline static bool svd_econ(Mat<std::complex<T> >& U, Col<T>& S,
  ...
  template <typename T>
  inline static bool svd_dc(Mat<std::complex<T> >& U, Col<T>& S, Mat<std::complex<T> >& V,
                            Mat<std::complex<T> >& A);
  ...
  template <typename T>
  inline static bool svd_dc_econ(Mat<std::complex<T> >& U, Col<T>& S,
                                 Mat<std::complex<T> >& V, Mat<std::complex<T> >& A);
  ...
  template <typename T1>
  inline static bool solve_square_rcond(Mat<typename T1::elem_type>& out,
  ...
  template <typename T1>
  inline static bool solve_square_refine(
  ...
  template <typename T1>
  inline static bool solve_sympd_fast(Mat<typename T1::elem_type>& out,
                                      Mat<typename T1::elem_type>& A,
                                      const Base<typename T1::elem_type, T1>& B_expr);

  template <typename T1>
  inline static bool solve_sympd_fast_common(
      Mat<typename T1::elem_type>& out, Mat<typename T1::elem_type>& A,
      const Base<typename T1::elem_type, T1>& B_expr);

  template <typename T1>
  inline static bool solve_sympd_rcond(Mat<typename T1::pod_type>& out,
  ...
  template <typename T1>
  inline static bool solve_sympd_rcond(
  ...
  template <typename T1>
  inline static bool solve_sympd_refine(Mat<typename T1::pod_type>& out,
                                        typename T1::pod_type& out_rcond,
                                        Mat<typename T1::pod_type>& A,
                                        const Base<typename T1::pod_type, T1>& B_expr,
                                        const bool equilibrate);
  ...
  template <typename T1>
  inline static bool solve_sympd_refine(
      Mat<std::complex<typename T1::pod_type> >& out, typename T1::pod_type& out_rcond,
      Mat<std::complex<typename T1::pod_type> >& A,
      const Base<std::complex<typename T1::pod_type>, T1>& B_expr,
      const bool equilibrate);
  ...
  template <typename T1>
  inline static bool solve_rect_fast(Mat<typename T1::elem_type>& out,
                                     Mat<typename T1::elem_type>& A,
                                     const Base<typename T1::elem_type, T1>& B_expr);

  template <typename T1>
  inline static bool solve_rect_rcond(Mat<typename T1::elem_type>& out,
                                      typename T1::pod_type& out_rcond,
                                      Mat<typename T1::elem_type>& A,
                                      const Base<typename T1::elem_type, T1>& B_expr);
  ...
  template <typename T1>
  inline static bool solve_approx_svd(
  ...
  template <typename T1>
  inline static bool solve_trimat_fast(Mat<typename T1::elem_type>& out,
                                       const Mat<typename T1::elem_type>& A,
                                       const Base<typename T1::elem_type, T1>& B_expr,
                                       const uword layout);

  template <typename T1>
  inline static bool solve_trimat_rcond(Mat<typename T1::elem_type>& out,
                                        typename T1::pod_type& out_rcond,
                                        const Mat<typename T1::elem_type>& A,
                                        const Base<typename T1::elem_type, T1>& B_expr,
                                        const uword layout);
  ...
  template <typename T1>
  inline static bool solve_band_fast(Mat<typename T1::pod_type>& out,
                                     Mat<typename T1::pod_type>& A, const uword KL,
                                     const uword KU,
                                     const Base<typename T1::pod_type, T1>& B_expr);

  template <typename T1>
  inline static bool solve_band_fast(
      Mat<std::complex<typename T1::pod_type> >& out,
      Mat<std::complex<typename T1::pod_type> >& A, const uword KL, const uword KU,
      const Base<std::complex<typename T1::pod_type>, T1>& B_expr);

  template <typename T1>
  inline static bool solve_band_fast_common(
  ...
  template <typename T1>
  inline static bool solve_band_rcond(Mat<typename T1::pod_type>& out,
                                      typename T1::pod_type& out_rcond,
                                      Mat<typename T1::pod_type>& A, const uword KL,
                                      const uword KU,
                                      const Base<typename T1::pod_type, T1>& B_expr);
  ...
  template <typename T1>
  inline static bool solve_band_rcond(
      Mat<std::complex<typename T1::pod_type> >& out, typename T1::pod_type& out_rcond,
      Mat<std::complex<typename T1::pod_type> >& A, const uword KL, const uword KU,
      const Base<std::complex<typename T1::pod_type>, T1>& B_expr);

  template <typename T1>
  inline static bool solve_band_rcond_common(
  ...
  template <typename T1>
  inline static bool solve_band_refine(Mat<typename T1::pod_type>& out,
                                       typename T1::pod_type& out_rcond,
                                       Mat<typename T1::pod_type>& A, const uword KL,
                                       const uword KU,
                                       const Base<typename T1::pod_type, T1>& B_expr,
  ...
  template <typename T1>
  inline static bool solve_band_refine(
      Mat<std::complex<typename T1::pod_type> >& out, typename T1::pod_type& out_rcond,
      Mat<std::complex<typename T1::pod_type> >& A, const uword KL, const uword KU,
      const Base<std::complex<typename T1::pod_type>, T1>& B_expr,
      const bool equilibrate);
  ...
  template <typename T1>
  inline static bool solve_tridiag_fast(Mat<typename T1::pod_type>& out,
                                        Mat<typename T1::pod_type>& A,
                                        const Base<typename T1::pod_type, T1>& B_expr);

  template <typename T1>
  inline static bool solve_tridiag_fast(
      Mat<std::complex<typename T1::pod_type> >& out,
      Mat<std::complex<typename T1::pod_type> >& A,
      const Base<std::complex<typename T1::pod_type>, T1>& B_expr);

  template <typename T1>
  inline static bool solve_tridiag_fast_common(
      Mat<typename T1::elem_type>& out, const Mat<typename T1::elem_type>& A,
      const Base<typename T1::elem_type, T1>& B_expr);
  ...
  template <typename eT, typename T1>
  inline static bool schur(Mat<eT>& U, Mat<eT>& S, const Base<eT, T1>& X,
                           const bool calc_U = true);

  template <typename T, typename T1>
  inline static bool schur(Mat<std::complex<T> >& U, Mat<std::complex<T> >& S,
                           const Base<std::complex<T>, T1>& X, const bool calc_U = true);
  ...
  template <typename eT>
  inline static bool syl(Mat<eT>& X, const Mat<eT>& A, const Mat<eT>& B,
                         const Mat<eT>& C);
  ...
  inline static bool qz(Mat<T>& A, Mat<T>& B, Mat<T>& vsl, Mat<T>& vsr,
                        const Base<T, T1>& X_expr, const Base<T, T2>& Y_expr,
                        const char mode);

  template <typename T, typename T1, typename T2>
  inline static bool qz(Mat<std::complex<T> >& A, Mat<std::complex<T> >& B,
  ...
  template <typename eT>
  inline static eT lu_rcond_band(const Mat<eT>& AB, const uword KL, const uword KU,
                                 const podarray<blas_int>& ipiv, const eT norm_val);

  template <typename T>
  inline static T lu_rcond_band(const Mat<std::complex<T> >& AB, const uword KL,
  ...
  template <typename eT>
  inline static typename get_pod_type<eT>::result norm1_band(const Mat<eT>& A,
                                                             const uword KL,
                                                             const uword KU);
};
