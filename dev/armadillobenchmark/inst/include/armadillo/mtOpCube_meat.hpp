...
inline mtOpCube<out_eT, T1, op_type>::mtOpCube(const T1& in_m) : m(in_m) {
  arma_debug_sigprint();
}
...
template <typename out_eT, typename T1, typename op_type>
inline mtOpCube<out_eT, T1, op_type>::mtOpCube(const T1& in_m, const uword in_aux_uword_a,
...
template <typename out_eT, typename T1, typename op_type>
inline mtOpCube<out_eT, T1, op_type>::mtOpCube(const char junk, const T1& in_m,
                                               const out_eT in_aux)
...
template <typename out_eT, typename T1, typename op_type>
inline mtOpCube<out_eT, T1, op_type>::mtOpCube(const mtOpCube_dual_aux_indicator&,
                                               const T1& in_m,
