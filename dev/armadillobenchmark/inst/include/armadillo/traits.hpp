...
struct is_Mat_fixed {
  static constexpr bool value =
      (is_Mat_fixed_only<T>::value || is_Row_fixed_only<T>::value ||
       is_Col_fixed_only<T>::value);
};
...
struct is_arma_type2 {
  static constexpr bool value =
      is_Mat<T1>::value || is_Gen<T1>::value || is_Op<T1>::value || is_Glue<T1>::value ||
      is_eOp<T1>::value || is_eGlue<T1>::value || is_mtOp<T1>::value ||
      is_mtGlue<T1>::value || is_diagview<T1>::value || is_subview<T1>::value ||
      is_subview_row<T1>::value || is_subview_col<T1>::value ||
      is_subview_cols<T1>::value || is_subview_elem1<T1>::value ||
      is_subview_elem2<T1>::value || is_CubeToMatOp<T1>::value || is_SpToDOp<T1>::value ||
      is_SpToDGlue<T1>::value;
};

// due to rather baroque C++ rules for proving constant expressions,
// certain compilers may get confused with the combination of conditional inheritance,
// nested classes and the shenanigans in is_Mat_fixed_only. below we explicitly ensure the
// type is forced to be const, which seems to eliminate the confusion.
template <typename T1>
struct is_arma_type {
...
struct is_arma_cube_type {
  static constexpr bool value =
      is_Cube<T1>::value || is_GenCube<T1>::value || is_OpCube<T1>::value ||
      is_eOpCube<T1>::value || is_mtOpCube<T1>::value || is_GlueCube<T1>::value ||
      is_eGlueCube<T1>::value || is_mtGlueCube<T1>::value || is_subview_cube<T1>::value ||
...
struct is_supported_elem_type {
  static constexpr bool value =
      is_u8<T1>::value || is_s8<T1>::value || is_u16<T1>::value || is_s16<T1>::value ||
      is_u32<T1>::value || is_s32<T1>::value || is_u64<T1>::value || is_s64<T1>::value ||
      is_ulng_t<T1>::value || is_slng_t<T1>::value || is_float<T1>::value ||
      is_double<T1>::value || is_cx_float<T1>::value || is_cx_double<T1>::value;
};

template <typename T1>
struct is_supported_blas_type {
  static constexpr bool value = is_float<T1>::value || is_double<T1>::value ||
                                is_cx_float<T1>::value || is_cx_double<T1>::value;
};
...
struct resolves_to_vector
    : public resolves_to_vector_redirect<T1, is_arma_type<T1>::value>::result {};

template <typename T1>
struct resolves_to_sparse_vector
    : public resolves_to_vector_redirect<T1, is_arma_sparse_type<T1>::value>::result {};
...
template <typename T1>
struct resolves_to_rowvector
    : public resolves_to_rowvector_redirect<T1, is_arma_type<T1>::value>::result {};
...
template <typename T1>
struct resolves_to_colvector
    : public resolves_to_colvector_redirect<T1, is_arma_type<T1>::value>::result {};
...
struct is_outer_product<Glue<T1, T2, glue_times> > {
  static constexpr bool value =
      (resolves_to_colvector<T1>::value && resolves_to_rowvector<T2>::value);
};
...
struct has_nested_op_traits {
  ...
  template <typename X>
  static yes& check(typename X::template traits<void>*);
  template <typename>
  static no& check(...);
...
struct has_nested_glue_traits {
  ...
  template <typename X>
  static yes& check(typename X::template traits<void, void>*);
  template <typename>
  static no& check(...);
