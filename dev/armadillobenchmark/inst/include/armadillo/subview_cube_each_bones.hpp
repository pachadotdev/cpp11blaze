...
class subview_cube_each1_aux {
 public:
  ...
  static inline Cube<eT> operator_plus(const subview_cube_each1<eT>& X,
                                       const Base<eT, T2>& Y);

  template <typename eT, typename T2>
  static inline Cube<eT> operator_minus(const subview_cube_each1<eT>& X,
                                        const Base<eT, T2>& Y);

  template <typename T1, typename eT>
  static inline Cube<eT> operator_minus(const Base<eT, T1>& X,
                                        const subview_cube_each1<eT>& Y);

  template <typename eT, typename T2>
  static inline Cube<eT> operator_schur(const subview_cube_each1<eT>& X,
                                        const Base<eT, T2>& Y);

  template <typename eT, typename T2>
  static inline Cube<eT> operator_div(const subview_cube_each1<eT>& X,
                                      const Base<eT, T2>& Y);

  template <typename T1, typename eT>
  static inline Cube<eT> operator_div(const Base<eT, T1>& X,
                                      const subview_cube_each1<eT>& Y);

  template <typename eT, typename T2>
  static inline Cube<eT> operator_times(const subview_cube_each1<eT>& X,
                                        const Base<eT, T2>& Y);

  template <typename T1, typename eT>
  static inline Cube<eT> operator_times(const Base<eT, T1>& X,
                                        const subview_cube_each1<eT>& Y);
};
...
class subview_cube_each2_aux {
 public:
  ...
  static inline Cube<eT> operator_plus(const subview_cube_each2<eT, TB>& X,
                                       const Base<eT, T2>& Y);

  template <typename eT, typename TB, typename T2>
  static inline Cube<eT> operator_minus(const subview_cube_each2<eT, TB>& X,
                                        const Base<eT, T2>& Y);
  ...
  template <typename eT, typename TB, typename T2>
  static inline Cube<eT> operator_schur(const subview_cube_each2<eT, TB>& X,
                                        const Base<eT, T2>& Y);

  template <typename eT, typename TB, typename T2>
  static inline Cube<eT> operator_div(const subview_cube_each2<eT, TB>& X,
                                      const Base<eT, T2>& Y);
