...
class arma_ostream {
 public:
  ...
  inline static std::streamsize modify_stream(std::ostream& o, const eT* data,
                                              const uword n_elem);
  template <typename T>
  inline static std::streamsize modify_stream(std::ostream& o,
                                              ...
                                              const uword n_elem);
  template <typename eT>
  inline static std::streamsize modify_stream(
  ...
  template <typename eT>
  inline static void print_elem(std::ostream& o, const eT& x, const bool modify);
  template <typename eT>
  inline static void raw_print_elem(std::ostream& o, const eT& x);

  template <typename T>
  inline static void print_elem(std::ostream& o, const std::complex<T>& x,
                                const bool modify);
  template <typename T>
  inline static void raw_print_elem(std::ostream& o, const std::complex<T>& x);

  template <typename eT>
  arma_cold inline static void print(std::ostream& o, const Mat<eT>& m,
                                     const bool modify);
  template <typename eT>
  arma_cold inline static void print(std::ostream& o, const Cube<eT>& m,
                                     const bool modify);
  ...
  template <typename eT>
  arma_cold inline static void print_dense(std::ostream& o, const SpMat<eT>& m,
                                           const bool modify);
  template <typename eT>
  arma_cold inline static void print(std::ostream& o, const SpMat<eT>& m,
                                     const bool modify);
  ...
  template <typename eT>
  arma_cold inline static void brief_print(std::ostream& o, const Mat<eT>& m,
                                           const bool print_size = true);
  template <typename eT>
  arma_cold inline static void brief_print(std::ostream& o, const Cube<eT>& m);
  template <typename eT>
  arma_cold inline static void brief_print(std::ostream& o, const SpMat<eT>& m);
};
