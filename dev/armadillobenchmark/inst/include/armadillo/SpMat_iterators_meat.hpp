...
inline SpMat<eT>::iterator_base::iterator_base()
    : M(nullptr), internal_col(0), internal_pos(0) {
...
template <typename eT>
inline SpMat<eT>::iterator_base::iterator_base(const SpMat<eT>& in_M, const uword in_col,
                                               const uword in_pos)
...
template <typename eT>
inline SpMat<eT>::const_iterator::const_iterator() : iterator_base() {}
...
inline SpMat<eT>::const_iterator::const_iterator(const SpMat<eT>& in_M, uword initial_pos)
  ...
  while (iterator_base::M->col_ptrs[iterator_base::internal_col + 1] <=
...
template <typename eT>
inline SpMat<eT>::const_iterator::const_iterator(const SpMat<eT>& in_M, uword in_row,
                                                 uword in_col)
...
template <typename eT>
inline SpMat<eT>::const_iterator::const_iterator(const SpMat<eT>& in_M,
                                                 const uword /* in_row */,
                                                 const uword in_col, const uword in_pos)
...
inline SpMat<eT>::const_iterator::const_iterator(
    const typename SpMat<eT>::const_iterator& other)
    : iterator_base(*other.M, other.internal_col, other.internal_pos) {
  // Nothing to do.
}

template <typename eT>
inline typename SpMat<eT>::const_iterator& SpMat<eT>::const_iterator::operator++() {
  ++iterator_base::internal_pos;
...
template <typename eT>
inline typename SpMat<eT>::const_iterator SpMat<eT>::const_iterator::operator++(int) {
...
inline typename SpMat<eT>::const_iterator& SpMat<eT>::const_iterator::operator--() {
  ...
  while (iterator_base::internal_pos <
         iterator_base::M->col_ptrs[iterator_base::internal_col]) {
    --iterator_base::internal_col;
  }
...
template <typename eT>
inline bool SpMat<eT>::const_iterator::operator==(const const_iterator& rhs) const {
...
template <typename eT>
inline bool SpMat<eT>::const_iterator::operator==(
...
template <typename eT>
inline bool SpMat<eT>::const_iterator::operator==(const const_row_iterator& rhs) const {
  return (rhs.row() == (*this).row()) && (rhs.col() == iterator_base::internal_col);
}
...
template <typename eT>
inline SpValProxy<SpMat<eT> > SpMat<eT>::iterator::operator*() {
...
template <typename eT>
inline typename SpMat<eT>::iterator& SpMat<eT>::iterator::operator++() {
...
template <typename eT>
inline typename SpMat<eT>::iterator SpMat<eT>::iterator::operator++(int) {
...
template <typename eT>
inline SpMat<eT>::const_row_iterator::const_row_iterator(const SpMat<eT>& in_M,
                                                         uword initial_pos)
  ...
  // (and add to our sum), then in row 1, and so forth, until we get to the desired
  // position.
...
template <typename eT>
inline SpMat<eT>::const_row_iterator::const_row_iterator(
    const typename SpMat<eT>::const_row_iterator& other)
    : iterator_base(*other.M, other.internal_col, other.internal_pos),
 ...
 */
template <typename eT>
inline typename SpMat<eT>::const_row_iterator&
SpMat<eT>::const_row_iterator::operator++() {
  ...
  for (uword col = iterator_base::internal_col + 1; col < iterator_base::M->n_cols;
       ++col) {
    // Find the first element with row greater than or equal to in_row.
    const uword col_offset = iterator_base::M->col_ptrs[col];
    const uword next_col_offset = iterator_base::M->col_ptrs[col + 1];
 ...
 */
template <typename eT>
inline typename SpMat<eT>::const_row_iterator SpMat<eT>::const_row_iterator::operator++(
    int) {
...
SpMat<eT>::const_row_iterator::operator--() {
  ...
  for (uword col = iterator_base::M->n_cols - 1; col >= iterator_base::internal_col;
       --col) {
    // Find the first element with row greater than or equal to in_row + 1.
    const uword col_offset = iterator_base::M->col_ptrs[col];
    const uword next_col_offset = iterator_base::M->col_ptrs[col + 1];
...
template <typename eT>
inline bool SpMat<eT>::const_row_iterator::operator==(const const_iterator& rhs) const {
...
template <typename eT>
inline bool SpMat<eT>::const_row_iterator::operator==(
    const typename SpSubview<eT>::const_iterator& rhs) const {
  return (rhs.row() == row()) && (rhs.col() == iterator_base::internal_col);
}
...
template <typename eT>
inline SpValProxy<SpMat<eT> > SpMat<eT>::row_iterator::operator*() {
  return SpValProxy<SpMat<eT> >(
      const_row_iterator::internal_row, iterator_base::internal_col,
      access::rw(*iterator_base::M),
      &access::rw(iterator_base::M->values[const_row_iterator::actual_pos]));
}

template <typename eT>
inline typename SpMat<eT>::row_iterator& SpMat<eT>::row_iterator::operator++() {
...
template <typename eT>
inline typename SpMat<eT>::row_iterator SpMat<eT>::row_iterator::operator++(int) {
