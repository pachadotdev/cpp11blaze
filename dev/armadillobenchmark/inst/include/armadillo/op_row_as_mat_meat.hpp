...
inline void op_row_as_mat::apply(Mat<typename T1::elem_type>& out,
                                 const CubeToMatOp<T1, op_row_as_mat>& expr) {
  arma_debug_sigprint();
  ...
  arma_conform_check_bounds((in_row >= A.n_rows),
                            "Cube::row_as_mat(): index out of bounds");
