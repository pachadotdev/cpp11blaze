      ...
      if (use_at == false) {                                                            \
        ...
        if (n_rows == 1) {                                                              \
          for (uword count = 0; count < n_cols; ++count) {                              \
            out_mem[count] =                                                            \
                (P1.at(0, count) operator_rel P2.at(0, count)) ? uword(1) : uword(0);   \
          }                                                                             \
        } else {                                                                        \
          for (uword col = 0; col < n_cols; ++col)                                      \
            for (uword row = 0; row < n_rows; ++row) {                                  \
              *out_mem =                                                                \
                  (P1.at(row, col) operator_rel P2.at(row, col)) ? uword(1) : uword(0); \
              out_mem++;                                                                \
            }                                                                           \
        }                                                                               \
      }                                                                                 \
    ...
    if (bad_alias == false) {                                                         \
      ...
      if (use_at == false) {                                                          \
        ...
        for (uword slice = 0; slice < n_slices; ++slice)                              \
          for (uword col = 0; col < n_cols; ++col)                                    \
            for (uword row = 0; row < n_rows; ++row) {                                \
              *out_mem = (P1.at(row, col, slice) operator_rel P2.at(row, col, slice)) \
                             ? uword(1)                                               \
                             : uword(0);                                              \
              out_mem++;                                                              \
            }                                                                         \
