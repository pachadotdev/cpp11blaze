...
class op_rel_lt_pre : public traits_op_passthru {
 public:
...
class op_rel_lt_post : public traits_op_passthru {
 public:
  template <typename T1>
  inline static void apply(Mat<uword>& out, const mtOp<uword, T1, op_rel_lt_post>& X);

  template <typename T1>
  inline static void apply(Cube<uword>& out,
                           const mtOpCube<uword, T1, op_rel_lt_post>& X);
};

class op_rel_gt_pre : public traits_op_passthru {
 public:
  template <typename T1>
...
class op_rel_gt_post : public traits_op_passthru {
 public:
  template <typename T1>
...
class op_rel_lteq_pre : public traits_op_passthru {
 public:
  template <typename T1>
...
class op_rel_lteq_post : public traits_op_passthru {
 public:
  template <typename T1>
...
class op_rel_gteq_pre : public traits_op_passthru {
 public:
  template <typename T1>
...
class op_rel_gteq_post : public traits_op_passthru {
 public:
  template <typename T1>
...
class op_rel_eq : public traits_op_passthru {
 public:
  template <typename T1>
...
class op_rel_noteq : public traits_op_passthru {
 public:
  template <typename T1>
