...
struct ProxyCube<Cube<eT> > {
  ...
  inline explicit ProxyCube(const Cube<eT>& A) : Q(A) { arma_debug_sigprint(); }
  ...
  arma_inline elem_type at(const uword r, const uword c, const uword s) const {
    return Q.at(r, c, s);
  }
  ...
  template <typename eT2>
  arma_inline bool has_overlap(const subview_cube<eT2>& X) const {
    return is_alias(X.m);
  }
...
struct ProxyCube<GenCube<eT, gen_type> > {
  ...
  inline explicit ProxyCube(const GenCube<eT, gen_type>& A) : Q(A) {
    arma_debug_sigprint();
  }
  ...
  template <typename eT2>
  constexpr bool is_alias(const Cube<eT2>&) const {
    return false;
  }

  template <typename eT2>
  constexpr bool has_overlap(const subview_cube<eT2>&) const {
    return false;
  }
...
struct ProxyCube<OpCube<T1, op_type> > {
  ...
  inline explicit ProxyCube(const OpCube<T1, op_type>& A) : Q(A) {
    arma_debug_sigprint();
  }
...
struct ProxyCube<GlueCube<T1, T2, glue_type> > {
  ...
  inline explicit ProxyCube(const GlueCube<T1, T2, glue_type>& A) : Q(A) {
    arma_debug_sigprint();
  }
...
struct ProxyCube<subview_cube<eT> > {
  ...
  inline explicit ProxyCube(const subview_cube<eT>& A) : Q(A) { arma_debug_sigprint(); }
...
struct ProxyCube<subview_cube_slices<eT, T1> > {
  ...
  inline explicit ProxyCube(const subview_cube_slices<eT, T1>& A) : Q(A) {
    arma_debug_sigprint();
  }
...
struct ProxyCube<eOpCube<T1, eop_type> > {
  ...
  inline explicit ProxyCube(const eOpCube<T1, eop_type>& A) : Q(A) {
    arma_debug_sigprint();
  }
...
struct ProxyCube<eGlueCube<T1, T2, eglue_type> > {
  ...
  inline explicit ProxyCube(const eGlueCube<T1, T2, eglue_type>& A) : Q(A) {
    arma_debug_sigprint();
  }
...
struct ProxyCube<mtOpCube<out_eT, T1, op_type> > {
  ...
  inline explicit ProxyCube(const mtOpCube<out_eT, T1, op_type>& A) : Q(A) {
    arma_debug_sigprint();
  }
...
struct ProxyCube<mtGlueCube<out_eT, T1, T2, glue_type> > {
  ...
  inline explicit ProxyCube(const mtGlueCube<out_eT, T1, T2, glue_type>& A) : Q(A) {
    arma_debug_sigprint();
  }
