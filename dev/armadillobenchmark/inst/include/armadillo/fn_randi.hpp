...
arma_warn_unused inline obj_type randi(
  ...
  arma_conform_check((a > b),
                     "randi(): incorrect distribution parameters; a must be less than b");
...
arma_warn_unused inline obj_type randi(
    ...
    const typename arma_Mat_Col_Row_only<obj_type>::result* junk2 = nullptr) {
  arma_debug_sigprint();
  arma_ignore(junk1);
  arma_ignore(junk2);
...
arma_warn_unused inline imat randi(const uword n_rows, const uword n_cols,
...
arma_warn_unused inline sword randi(const distr_param& param) {
  arma_debug_sigprint();
...
arma_warn_unused inline typename arma_scalar_only<eT>::result randi(
...
arma_warn_unused inline sword randi() {
  arma_debug_sigprint();
...
arma_warn_unused inline cube_type randi(
...
arma_warn_unused inline icube randi(const uword n_rows, const uword n_cols,
