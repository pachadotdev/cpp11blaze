...
class subview_cube_slices : public BaseCube<eT, subview_cube_slices<eT, T1> > {
 ...
 public:
  ...
  inline void inplace_op(const BaseCube<eT, expr>& x);
  ...
  inline void operator_equ(const subview_cube_slices<eT, T2>& x);
  template <typename T2>
  inline void operator=(const subview_cube_slices<eT, T2>& x);
  ...
  inline void operator=(const BaseCube<eT, expr>& x);
  template <typename expr>
  inline void operator+=(const BaseCube<eT, expr>& x);
  template <typename expr>
  inline void operator-=(const BaseCube<eT, expr>& x);
