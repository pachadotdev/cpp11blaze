...
class op_reshape : public traits_op_default {
 public:
  ...
  inline static void apply_mat_inplace(Mat<eT>& A, const uword new_n_rows,
                                       const uword new_n_cols);

  template <typename eT>
  inline static void apply_mat_noalias(Mat<eT>& out, const Mat<eT>& A,
                                       const uword new_n_rows, const uword new_n_cols);

  template <typename T1>
  inline static void apply_proxy_noalias(Mat<typename T1::elem_type>& out,
  ...
  template <typename eT>
  inline static void apply_cube_inplace(Cube<eT>& A, const uword new_n_rows,
                                        const uword new_n_cols, const uword new_n_slices);

  template <typename eT>
  inline static void apply_cube_noalias(Cube<eT>& out, const Cube<eT>& A,
                                        const uword new_n_rows, const uword new_n_cols,
