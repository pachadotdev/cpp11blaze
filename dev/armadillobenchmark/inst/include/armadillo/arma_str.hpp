...
class char_buffer {
 public:
  ...
  inline void set_size(const uword new_n_chars) {
    if (n_chars > n_chars_prealloc) {
      std::free(mem);
    }

    mem = (new_n_chars <= n_chars_prealloc) ? &(local_mem[0])
                                            : (char*)std::malloc(new_n_chars);
...
inline basic_format<basic_format<T1, T2>, T3> operator%(const basic_format<T1, T2>& X,
                                                        const T3& arg) {
...
inline std::string str(const basic_format<format, T2>& X) {
  ...
  while (status == false) {
    int required_size =
        (std::snprintf)(buf.mem, size_t(buf.n_chars), X.A.fmt.c_str(), X.B);
    ...
    if (uword(required_size) >= buf.n_chars) {
      if (buf.n_chars > char_buffer::n_chars_prealloc) {
        break;
      }
...
inline std::string str(const basic_format<basic_format<format, T2>, T3>& X) {
  ...
  while (status == false) {
    int required_size =
        (std::snprintf)(buf.mem, size_t(buf.n_chars), X.A.A.fmt.c_str(), X.A.B, X.B);
...
inline std::string str(
    const basic_format<basic_format<basic_format<format, T2>, T3>, T4>& X) {
  char_buffer buf;
  std::string out;
  ...
  while (status == false) {
    int required_size = (std::snprintf)(buf.mem, size_t(buf.n_chars), X.A.A.A.fmt.c_str(),
                                        X.A.A.B, X.A.B, X.B);
...
inline std::string str(
    const basic_format<basic_format<basic_format<basic_format<format, T2>, T3>, T4>, T5>&
        X) {
  char_buffer buf;
  std::string out;
  ...
  while (status == false) {
    int required_size =
        (std::snprintf)(buf.mem, size_t(buf.n_chars), X.A.A.A.A.fmt.c_str(), X.A.A.A.B,
                        X.A.A.B, X.A.B, X.B);
...
inline std::string str(
    const basic_format<
        basic_format<basic_format<basic_format<basic_format<format, T2>, T3>, T4>, T5>,
        T6>& X) {
  char_buffer buf;
  std::string out;
  ...
  while (status == false) {
    int required_size =
        (std::snprintf)(buf.mem, size_t(buf.n_chars), X.A.A.A.A.A.fmt.c_str(),
                        X.A.A.A.A.B, X.A.A.A.B, X.A.A.B, X.A.B, X.B);
...
str(const basic_format<
  ...
  while (status == false) {
    int required_size =
        (std::snprintf)(buf.mem, size_t(buf.n_chars), X.A.A.A.A.A.A.fmt.c_str(),
                        X.A.A.A.A.A.B, X.A.A.A.A.B, X.A.A.A.B, X.A.A.B, X.A.B, X.B);
...
template <typename T1>
inline static const T1& str_wrapper(
    const T1& x, const typename string_only<T1>::result* junk = nullptr) {
  arma_ignore(junk);
...
template <typename T1>
inline static const T1* str_wrapper(
    const T1* x, const typename char_only<T1>::result* junk = nullptr) {
  arma_ignore(junk);
...
template <typename T1>
inline static std::string str_wrapper(
    const T1& x, const typename basic_format_only<T1>::result* junk = nullptr) {
  arma_ignore(junk);
