...
inline void op_cumprod::apply_noalias(Mat<eT>& out, const Mat<eT>& X, const uword dim) {
  arma_debug_sigprint();
...
inline void op_cumprod::apply(Mat<typename T1::elem_type>& out,
                              const Op<T1, op_cumprod>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void op_cumprod_vec::apply(Mat<typename T1::elem_type>& out,
                                  const Op<T1, op_cumprod_vec>& in) {
  arma_debug_sigprint();
