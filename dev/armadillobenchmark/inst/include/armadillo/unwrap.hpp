...
struct unwrap : public unwrap_redirect<T1, is_Mat_fixed<T1>::value>::result {
  inline unwrap(const T1& A) : unwrap_redirect<T1, is_Mat_fixed<T1>::value>::result(A) {}
};
...
struct quasi_unwrap : public quasi_unwrap_redirect<T1, is_Mat_fixed<T1>::value>::result {
  typedef typename quasi_unwrap_redirect<T1, is_Mat_fixed<T1>::value>::result
      quasi_unwrap_extra;

  inline quasi_unwrap(const T1& A) : quasi_unwrap_extra(A) {}
...
struct quasi_unwrap<subview<eT> > {
  ...
  static constexpr bool has_orig_mem =
      false;  // NOTE: set to false as this is the general case; original memory is only
              // used when the subview is a contiguous chunk
...
template <typename T1>
struct quasi_unwrap_Col_htrans_redirect<T1, true> {
  typedef quasi_unwrap_default<T1> result;
};

template <typename T1>
struct quasi_unwrap_Col_htrans_redirect<T1, false> {
  typedef quasi_unwrap_Col_htrans<T1> result;
};

template <typename eT>
struct quasi_unwrap<Op<Col<eT>, op_htrans> >
    : public quasi_unwrap_Col_htrans_redirect<Op<Col<eT>, op_htrans>,
                                              is_cx<eT>::value>::result {
  typedef typename quasi_unwrap_Col_htrans_redirect<
      Op<Col<eT>, op_htrans>, is_cx<eT>::value>::result quasi_unwrap_Col_htrans_extra;
...
template <typename T1>
struct quasi_unwrap_Row_htrans_redirect<T1, true> {
  typedef quasi_unwrap_default<T1> result;
};

template <typename T1>
struct quasi_unwrap_Row_htrans_redirect<T1, false> {
  typedef quasi_unwrap_Row_htrans<T1> result;
};

template <typename eT>
struct quasi_unwrap<Op<Row<eT>, op_htrans> >
    : public quasi_unwrap_Row_htrans_redirect<Op<Row<eT>, op_htrans>,
                                              is_cx<eT>::value>::result {
  typedef typename quasi_unwrap_Row_htrans_redirect<
      Op<Row<eT>, op_htrans>, is_cx<eT>::value>::result quasi_unwrap_Row_htrans_extra;
...
template <typename T1>
struct quasi_unwrap_subview_col_htrans_redirect<T1, true> {
  typedef quasi_unwrap_default<T1> result;
};

template <typename T1>
struct quasi_unwrap_subview_col_htrans_redirect<T1, false> {
  typedef quasi_unwrap_subview_col_htrans<T1> result;
};

template <typename eT>
struct quasi_unwrap<Op<subview_col<eT>, op_htrans> >
    : public quasi_unwrap_subview_col_htrans_redirect<Op<subview_col<eT>, op_htrans>,
                                                      is_cx<eT>::value>::result {
  typedef
      typename quasi_unwrap_subview_col_htrans_redirect<Op<subview_col<eT>, op_htrans>,
                                                        is_cx<eT>::value>::result
          quasi_unwrap_subview_col_htrans_extra;
  ...
  static constexpr bool has_orig_mem =
      quasi_unwrap_subview_col_htrans_extra::has_orig_mem;
...
struct partial_unwrap
    : public partial_unwrap_redirect<T1, is_Mat_fixed<T1>::value>::result {
...
struct partial_unwrap<Op<T1, op_htrans> >
    : public partial_unwrap_htrans_redirect<T1, is_Mat_fixed<T1>::value>::result {
...
struct partial_unwrap<Op<subview<eT>, op_htrans> > {
  ...
  inline partial_unwrap(const Op<subview<eT>, op_htrans>& A)
      : sv(A.m),
        M(A.m, ((A.m.aux_row1 == 0) &&
                (A.m.n_rows ==
...
struct partial_unwrap<Op<T1, op_htrans2> >
    : public partial_unwrap_htrans2_redirect<T1, is_Mat_fixed<T1>::value>::result {
...
struct partial_unwrap<Op<subview<eT>, op_htrans2> > {
  ...
  inline partial_unwrap(const Op<subview<eT>, op_htrans2>& A)
      : sv(A.m),
        val(A.aux),
        M(A.m, ((A.m.aux_row1 == 0) &&
                (A.m.n_rows ==
...
struct partial_unwrap<Op<subview_cols<eT>, op_htrans2> > {
  ...
  inline partial_unwrap(const Op<subview_cols<eT>, op_htrans2>& A)
      : orig(A.m.m),
        val(A.aux),
        M(const_cast<eT*>(A.m.colptr(0)), A.m.n_rows, A.m.n_cols, false, false) {
    arma_debug_sigprint();
...
struct partial_unwrap<eOp<T1, eop_scalar_times> >
    : public partial_unwrap_scalar_times_redirect<T1, is_Mat_fixed<T1>::value>::result {
  typedef typename T1::elem_type eT;
...
struct partial_unwrap<eOp<T1, eop_neg> >
    : public partial_unwrap_neg_redirect<T1, is_Mat_fixed<T1>::value>::result {
  typedef typename T1::elem_type eT;
...
template <typename T1>
struct partial_unwrap_check
    : public partial_unwrap_check_redirect<T1, is_Mat_fixed<T1>::value>::result {
  typedef typename T1::elem_type eT;
...
// NOTE: we can get away with this shortcut as the partial_unwrap_check class is only used
// by the glue_times class, NOTE: which relies on partial_unwrap_check to check for
// aliasing
template <typename eT>
...
struct partial_unwrap_check_htrans_fixed {
  ...
  inline explicit partial_unwrap_check_htrans_fixed(const Op<T1, op_htrans>& A,
                                                    const Mat<eT>& B)
...
template <typename T1>
struct partial_unwrap_check<Op<T1, op_htrans> >
    : public partial_unwrap_check_htrans_redirect<T1, is_Mat_fixed<T1>::value>::result {
  typedef typename T1::elem_type eT;
...
struct partial_unwrap_check_htrans2_fixed {
  ...
  inline explicit partial_unwrap_check_htrans2_fixed(const Op<T1, op_htrans2>& A,
                                                     const Mat<eT>& B)
      : val(A.aux),
        M_local((&(A.m) == &B) ? new T1(A.m) : nullptr),
        M((&(A.m) == &B) ? (*M_local) : A.m) {
...
template <typename T1>
struct partial_unwrap_check<Op<T1, op_htrans2> >
    : public partial_unwrap_check_htrans2_redirect<T1, is_Mat_fixed<T1>::value>::result {
  typedef typename T1::elem_type eT;
...
struct partial_unwrap_check_scalar_times_fixed {
  ...
  inline explicit partial_unwrap_check_scalar_times_fixed(
      const eOp<T1, eop_scalar_times>& A, const Mat<eT>& B)
      : val(A.aux),
...
template <typename T1>
struct partial_unwrap_check<eOp<T1, eop_scalar_times> >
    : public partial_unwrap_check_scalar_times_redirect<T1,
                                                        is_Mat_fixed<T1>::value>::result {
  typedef typename T1::elem_type eT;

  inline partial_unwrap_check(const eOp<T1, eop_scalar_times>& A, const Mat<eT>& B)
      : partial_unwrap_check_scalar_times_redirect<T1, is_Mat_fixed<T1>::value>::result(
            A, B) {}
};
...
struct partial_unwrap_check<eOp<subview_col<eT>, eop_scalar_times> > {
  ...
  inline partial_unwrap_check(const eOp<subview_col<eT>, eop_scalar_times>& A,
                              const Mat<eT>& B)
      : val(A.aux),
...
struct partial_unwrap_check_neg_fixed {
  ...
  inline explicit partial_unwrap_check_neg_fixed(const eOp<T1, eop_neg>& A,
                                                 const Mat<eT>& B)
      : M_local((&(A.P.Q) == &B) ? new T1(A.P.Q) : nullptr),
        M((&(A.P.Q) == &B) ? (*M_local) : A.P.Q) {
    arma_debug_sigprint();
...
template <typename T1>
struct partial_unwrap_check<eOp<T1, eop_neg> >
    : public partial_unwrap_check_neg_redirect<T1, is_Mat_fixed<T1>::value>::result {
  typedef typename T1::elem_type eT;
