...
//! B is one of: U (for unsigned types), S (for signed types), N (for not applicable) or C
//! (for complex types). XYZ specifies the width of each element in terms of bytes, eg.
//! "008" indicates eight bytes.
template <typename eT>
inline std::string diskio::gen_txt_header(const Mat<eT>&) {
  ...
  if (is_u8<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_TXT_IU001);
  } else if (is_s8<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_TXT_IS001);
  } else if (is_u16<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_TXT_IU002);
  } else if (is_s16<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_TXT_IS002);
  } else if (is_u32<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_TXT_IU004);
  } else if (is_s32<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_TXT_IS004);
  } else if (is_u64<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_TXT_IU008);
  } else if (is_s64<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_TXT_IS008);
    ...
    header = const_cast<char*>(ARMA_MAT_TXT_FN004);
  } else if (is_double<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_TXT_FN008);
  } else if (is_cx_float<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_TXT_FC008);
  } else if (is_cx_double<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_TXT_FC016);
  }
...
//! "008" indicates eight bytes.
template <typename eT>
inline std::string diskio::gen_bin_header(const Mat<eT>&) {
  arma_type_check((is_supported_elem_type<eT>::value == false));
  ...
  if (is_u8<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_IU001);
  } else if (is_s8<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_IS001);
  } else if (is_u16<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_IU002);
  } else if (is_s16<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_IS002);
  } else if (is_u32<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_IU004);
  } else if (is_s32<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_IS004);
  } else if (is_u64<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_IU008);
  } else if (is_s64<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_IS008);
  } else if (is_ulng_t_32<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_IU004);
  } else if (is_slng_t_32<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_IS004);
    ...
    header = const_cast<char*>(ARMA_MAT_BIN_FN004);
  } else if (is_double<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_FN008);
  } else if (is_cx_float<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_FC008);
  } else if (is_cx_double<eT>::value) {
    header = const_cast<char*>(ARMA_MAT_BIN_FC016);
  }
...
//! "008" indicates eight bytes.
template <typename eT>
inline std::string diskio::gen_bin_header(const SpMat<eT>&) {
  arma_type_check((is_supported_elem_type<eT>::value == false));
  ...
  if (is_u8<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_IU001);
  } else if (is_s8<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_IS001);
  } else if (is_u16<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_IU002);
  } else if (is_s16<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_IS002);
  } else if (is_u32<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_IU004);
  } else if (is_s32<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_IS004);
  } else if (is_u64<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_IU008);
  } else if (is_s64<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_IS008);
  } else if (is_ulng_t_32<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_IU004);
  } else if (is_slng_t_32<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_IS004);
    ...
    header = const_cast<char*>(ARMA_SPM_BIN_FN004);
  } else if (is_double<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_FN008);
  } else if (is_cx_float<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_FC008);
  } else if (is_cx_double<eT>::value) {
    header = const_cast<char*>(ARMA_SPM_BIN_FC016);
  }
...
//! "008" indicates eight bytes.
template <typename eT>
inline std::string diskio::gen_txt_header(const Cube<eT>&) {
  arma_type_check((is_supported_elem_type<eT>::value == false));
  ...
  if (is_u8<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_IU001);
  } else if (is_s8<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_IS001);
  } else if (is_u16<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_IU002);
  } else if (is_s16<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_IS002);
  } else if (is_u32<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_IU004);
  } else if (is_s32<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_IS004);
  } else if (is_u64<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_IU008);
  } else if (is_s64<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_IS008);
  } else if (is_ulng_t_32<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_IU004);
  } else if (is_slng_t_32<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_IS004);
    ...
    header = const_cast<char*>(ARMA_CUB_TXT_FN004);
  } else if (is_double<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_FN008);
  } else if (is_cx_float<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_FC008);
  } else if (is_cx_double<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_TXT_FC016);
  }
...
//! "008" indicates eight bytes.
template <typename eT>
inline std::string diskio::gen_bin_header(const Cube<eT>&) {
  arma_type_check((is_supported_elem_type<eT>::value == false));
  ...
  if (is_u8<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_IU001);
  } else if (is_s8<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_IS001);
  } else if (is_u16<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_IU002);
  } else if (is_s16<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_IS002);
  } else if (is_u32<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_IU004);
  } else if (is_s32<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_IS004);
  } else if (is_u64<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_IU008);
  } else if (is_s64<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_IS008);
  } else if (is_ulng_t_32<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_IU004);
  } else if (is_slng_t_32<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_IS004);
    ...
    header = const_cast<char*>(ARMA_CUB_BIN_FN004);
  } else if (is_double<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_FN008);
  } else if (is_cx_float<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_FC008);
  } else if (is_cx_double<eT>::value) {
    header = const_cast<char*>(ARMA_CUB_BIN_FC016);
  }

  return std::string(header);
}

inline file_type diskio::guess_file_type(std::istream& f) {
  arma_debug_sigprint();

  return diskio::guess_file_type_internal(f);
}

inline file_type diskio::guess_file_type_internal(std::istream& f) {
  arma_debug_sigprint();
  ...
  const uword N_max =
      ((pos1 >= 0) && (pos2 >= 0) && (pos2 > pos1)) ? uword(pos2 - pos1) : uword(0);
  ...
  // if the data has semicolons, it suggests a CSV file with semicolon as the separating
  // character; the semicolon may be used to allow the comma character to represent the
  // decimal seperator (eg. 1,2345 vs 1.2345)

  if (has_semicolon && (has_bracket == false)) {
    return ssv_ascii;
  }
...
inline std::string diskio::gen_tmp_name(const std::string& x) {
  union {
    uword val;
    void* ptr;
  } u;
...
inline bool diskio::safe_rename(const std::string& old_name,
...
inline bool diskio::is_readable(const std::string& name) {
  std::ifstream f;
...
inline void diskio::sanitise_token(std::string& token) {
  ...
  if ((c_front == ' ') || (c_front == '\t') || (c_front == '\r') || (c_back == ' ') ||
      (c_back == '\t') || (c_back == '\r')) {
    token.erase(
...
template <typename eT>
inline bool diskio::convert_token(eT& val, const std::string& token) {
  ...
  if ((N == 3) || (N == 4)) {
    ...
    if (((sig_a == 'i') || (sig_a == 'I')) && ((sig_b == 'n') || (sig_b == 'N')) &&
        ((sig_c == 'f') || (sig_c == 'F'))) {
      val =
          neg ? cond_rel<is_signed<eT>::value>::make_neg(Datum<eT>::inf) : Datum<eT>::inf;
  ...
  //     eT result_val = eT(0);
  //
  //     const std::from_chars_result result_state = std::from_chars(str, str+N,
  //     result_val);
  //
...
template <typename T>
inline bool diskio::convert_token(std::complex<T>& val, const std::string& token) {
  const size_t N = size_t(token.length());
  ...
  if ((token[0] != '(') || (token[Nm1] != ')')) {
    ...
    const bool state = diskio::convert_token(
        val_real, token);  // use the non-complex version of this function
  ...
  if (comma_found == false) {
    ...
    state = diskio::convert_token(
        val_real, token_real);  // use the non-complex version of this function
...
template <typename eT>
inline bool diskio::convert_token_strict(eT& val, const std::string& token) {
  const size_t N = size_t(token.length());
...
template <typename eT>
inline std::streamsize diskio::prepare_stream(std::ostream& f) {
  ...
  if (is_real<eT>::value) {
    ...
    // NOTE: however, to avoid introducing errors in case single precision data is loaded
    // as double precision, NOTE: the same settings must be used for both 'float' and
    // 'double'
...
//! Matrices can be loaded in Matlab and Octave, as long as they don't have complex
//! elements.
template <typename eT>
inline bool diskio::save_raw_ascii(const Mat<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
  ...
  (arma_config::text_as_binary) ? f.open(tmp_name, std::fstream::binary)
                                : f.open(tmp_name);
...
//! elements.
template <typename eT>
inline bool diskio::save_raw_ascii(const Mat<eT>& x, std::ostream& f) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_raw_binary(const Mat<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_raw_binary(const Mat<eT>& x, std::ostream& f) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_arma_ascii(const Mat<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
//! with a header that indicates the matrix type as well as its dimensions
template <typename eT>
inline bool diskio::save_arma_ascii(const Mat<eT>& x, std::ostream& f) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_csv_ascii(const Mat<eT>& x, const std::string& final_name,
                                   const field<std::string>& header,
                                   const bool with_header, const char separator) {
  arma_debug_sigprint();
  ...
  if (save_okay) {
    save_okay = diskio::save_csv_ascii(x, f, separator);
  }
...
//! Save a matrix in CSV text format (human readable)
template <typename eT>
inline bool diskio::save_csv_ascii(const Mat<eT>& x, std::ostream& f,
  ...
  for (uword row = 0; row < x_n_rows; ++row) {
    for (uword col = 0; col < x_n_cols; ++col) {
      ...
      const bool is_real_int = (is_real<eT>::yes) && arma_isfinite(val) &&
                               (val > eT_int_lowest) && (val < eT_int_max) &&
                               (eT(int(val)) == val);

      (is_real_int) ? arma_ostream::raw_print_elem(f, int(val))
...
inline bool diskio::save_csv_ascii(const Mat<std::complex<T> >& x, std::ostream& f,
  ...
  for (uword row = 0; row < x_n_rows; ++row) {
    for (uword col = 0; col < x_n_cols; ++col) {
      ...
      const bool val_r_is_real_int = (is_real<T>::yes) && arma_isfinite(val_r) &&
                                     (val_r > T_int_lowest) && (val_r < T_int_max) &&
                                     (T(int(val_r)) == val_r);
      const bool abs_i_is_real_int = (is_real<T>::yes) && arma_isfinite(abs_i) &&
                                     (abs_i < T_int_max) && (T(int(abs_i)) == abs_i);

      (val_r_is_real_int) ? arma_ostream::raw_print_elem(f, int(val_r))
                          : arma_ostream::raw_print_elem(f, val_r);

      f.put(sgn_i);

      (abs_i_is_real_int) ? arma_ostream::raw_print_elem(f, int(abs_i))
                          : arma_ostream::raw_print_elem(f, abs_i);
...
template <typename eT>
inline bool diskio::save_coord_ascii(const Mat<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_coord_ascii(const Mat<eT>& x, std::ostream& f) {
  arma_debug_sigprint();
...
template <typename T>
inline bool diskio::save_coord_ascii(const Mat<std::complex<T> >& x, std::ostream& f) {
  arma_debug_sigprint();
  ...
  for (uword col = 0; col < x.n_cols; ++col)
    for (uword row = 0; row < x.n_rows; ++row) {
      ...
      const bool val_r_is_real_int = (is_real<T>::yes) && arma_isfinite(val_r) &&
                                     (val_r > T_int_lowest) && (val_r < T_int_max) &&
                                     (T(int(val_r)) == val_r);
      const bool val_i_is_real_int = (is_real<T>::yes) && arma_isfinite(val_i) &&
                                     (val_i > T_int_lowest) && (val_i < T_int_max) &&
                                     (T(int(val_i)) == val_i);
      ...
      (val_i_is_real_int) ? arma_ostream::raw_print_elem(f, int(val_i))
                          : arma_ostream::raw_print_elem(f, val_i);
...
template <typename eT>
inline bool diskio::save_arma_binary(const Mat<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
//! with a header that stores the matrix type as well as its dimensions
template <typename eT>
inline bool diskio::save_arma_binary(const Mat<eT>& x, std::ostream& f) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_pgm_binary(const Mat<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
//! Save a matrix as a PGM greyscale image
template <typename eT>
inline bool diskio::save_pgm_binary(const Mat<eT>& x, std::ostream& f) {
  arma_debug_sigprint();
...
inline bool diskio::save_hdf5_binary(const Mat<eT>& x, const hdf5_name& spec,
...
#if defined(ARMA_USE_HDF5)
  {
    ...
    const bool use_existing_file =
        ((append || replace) && (H5Fis_hdf5(spec.filename.c_str()) > 0));

    const std::string tmp_name =
        (use_existing_file) ? std::string() : diskio::gen_tmp_name(spec.filename);

    // Set up the file according to HDF5's preferences
    hid_t file =
        (use_existing_file)
            ? H5Fopen(spec.filename.c_str(), H5F_ACC_RDWR, H5P_DEFAULT)
            : H5Fcreate(tmp_name.c_str(), H5F_ACC_TRUNC, H5P_DEFAULT, H5P_DEFAULT);
    ...
    hid_t dataspace =
        H5Screate_simple(2, dims, NULL);  // treat the matrix as a 2d array dataspace
    hid_t datatype = hdf5_misc::get_hdf5_type<eT>();

    // fail if we can't handle the datatype
    if (datatype == -1) {
      err_msg = "unknown datatype for HDF5";
      return false;
    }
    ...
    while ((loc = full_name.find("/")) != std::string::npos) {
      ...
      {
        hid_t gid = H5Gcreate((groups.size() == 0) ? file : groups[groups.size() - 1],
                              full_name.substr(0, loc).c_str(), H5P_DEFAULT, H5P_DEFAULT,
                              H5P_DEFAULT);

        if ((gid < 0) && use_existing_file) {
          gid = H5Gopen((groups.size() == 0) ? file : groups[groups.size() - 1],
                        full_name.substr(0, loc).c_str(), H5P_DEFAULT);
        }
    ...
    const std::string dataset_name =
        full_name.empty() ? std::string("dataset") : full_name;
    ...
    if (use_existing_file && replace) {
      ...
      // NOTE: H5Ldelete() in HDF5 v1.8 doesn't reclaim the deleted space; use h5repack to
      // reclaim space: h5repack oldfile.h5 newfile.h5 NOTE: has this behaviour changed in
      // HDF5 1.10 ? NOTE:
      // https://lists.hdfgroup.org/pipermail/hdf-forum_lists.hdfgroup.org/2017-August/010482.html
      // NOTE:
      // https://lists.hdfgroup.org/pipermail/hdf-forum_lists.hdfgroup.org/2017-August/010486.html
    }

    hid_t dataset = H5Dcreate(last_group, dataset_name.c_str(), datatype, dataspace,
    ...
    if (dataset < 0) {
      ...
      save_okay =
          (H5Dwrite(dataset, datatype, H5S_ALL, H5S_ALL, H5P_DEFAULT, x.mem) >= 0);
    ...
    if ((use_existing_file == false) && (save_okay == true)) {
...
template <typename eT>
inline bool diskio::load_raw_ascii(Mat<eT>& x, const std::string& name,
                                   std::string& err_msg) {
  arma_debug_sigprint();
...
//! NOTE: this is much slower than reading a file with a header.
template <typename eT>
inline bool diskio::load_raw_ascii(Mat<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
  ...
  if (load_okay) {
    ...
    if (f.fail() || (f.tellg() != pos1)) {
      err_msg = "seek failure";
      return false;
    }
...
template <typename eT>
inline bool diskio::load_raw_binary(Mat<eT>& x, const std::string& name,
                                    std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_raw_binary(Mat<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
  ...
  f.read(reinterpret_cast<char*>(x.memptr()),
         std::streamsize(x.n_elem * uword(sizeof(eT))));
...
//! with a header that indicates the matrix type as well as its dimensions
template <typename eT>
inline bool diskio::load_arma_ascii(Mat<eT>& x, const std::string& name,
                                    std::string& err_msg) {
  arma_debug_sigprint();
...
//! with a header that indicates the matrix type as well as its dimensions
template <typename eT>
inline bool diskio::load_arma_ascii(Mat<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_csv_ascii(Mat<eT>& x, const std::string& name,
                                   std::string& err_msg, field<std::string>& header,
                                   const bool with_header, const char separator,
                                   const bool strict) {
  arma_debug_sigprint();
  ...
  if (with_header) {
    ...
    if (load_okay) {
      ...
      if (header_n_tokens == uword(0)) {
        ...
        for (uword i = 0; i < header_n_tokens; ++i) {
          header.at(i) = header_tokens[i];
        }
      }
    }
  }
...
//! Load a matrix in CSV text format (human readable)
template <typename eT>
inline bool diskio::load_csv_ascii(Mat<eT>& x, std::istream& f, std::string& err_msg,
                                   const char separator, const bool strict) {
  arma_debug_sigprint();
  ...
  if (strict) {
    x.fill(Datum<eT>::nan);
  }  // take into account that each row may have a unique number of columns
  ...
  if (use_mp) {
    try {
      ...
      for (uword i = 0; i < f_n_cols; ++i) {
        token_array(i).reserve(32);
      }
...
#pragma omp parallel for schedule(static) num_threads(n_threads)
        for (uword col = 0; col < line_stream_col; ++col) {
          ...
          (strict) ? diskio::convert_token_strict(out_val, token_array(col))
                   : diskio::convert_token(out_val, token_array(col));
        }
  ...
  } else  // serial implementation
  {
    ...
    while (f.good()) {
      ...
      while (line_stream.good()) {
        ...
        (strict) ? diskio::convert_token_strict(out_val, token)
                 : diskio::convert_token(out_val, token);
...
//! format
template <typename T>
inline bool diskio::load_csv_ascii(Mat<std::complex<T> >& x, std::istream& f,
                                   std::string& err_msg, const char separator,
                                   const bool strict) {
  arma_debug_sigprint();
  ...
  if (strict) {
    x.fill(Datum<std::complex<T> >::nan);
  }  // take into account that each row may have a unique number of columns
  ...
  while (f.good()) {
    ...
    while (line_stream.good()) {
      ...
      bool found_x = false;
      std::string::size_type loc_x =
          0;  // location of the separator (+ or -) between the real and imaginary part

      std::string::size_type loc_i =
          token.find_last_of('i');  // location of the imaginary part indicator
      ...
      if (loc_i == std::string::npos) {
        ...
        if (found_plus && found_minus) {
          if ((loc_i > loc_plus) && (loc_i > loc_minus)) {
            // choose the sign closest to the "i" to be the separator between the real and
            // imaginary part
      ...
      (strict) ? diskio::convert_token_strict(val_real, str_real)
               : diskio::convert_token(val_real, str_real);
      (strict) ? diskio::convert_token_strict(val_imag, str_imag)
...
template <typename eT>
inline bool diskio::load_coord_ascii(Mat<eT>& x, const std::string& name,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
//! Load a matrix in CSV text format (human readable)
template <typename eT>
inline bool diskio::load_coord_ascii(Mat<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename T>
inline bool diskio::load_coord_ascii(Mat<std::complex<T> >& x, std::istream& f,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
//! with a header that indicates the matrix type as well as its dimensions
template <typename eT>
inline bool diskio::load_arma_binary(Mat<eT>& x, const std::string& name,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_arma_binary(Mat<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
  ...
  if (f_header == diskio::gen_bin_header(x)) {
    // f.seekg(1, ios::cur);  // NOTE: this may not be portable, as on a Windows machine a
    // newline could be two characters
    f.get();
...
inline void diskio::pnm_skip_comments(std::istream& f) {
...
template <typename eT>
inline bool diskio::load_pgm_binary(Mat<eT>& x, const std::string& name,
                                    std::string& err_msg) {
  arma_debug_sigprint();
...
//! Load a PGM greyscale image as a matrix
template <typename eT>
inline bool diskio::load_pgm_binary(Mat<eT>& x, std::istream& f, std::string& err_msg) {
  bool load_okay = true;
...
//! Load a PGM greyscale image as a matrix
template <typename T>
inline bool diskio::load_pgm_binary(Mat<std::complex<T> >& x, const std::string& name,
                                    std::string& err_msg) {
  arma_debug_sigprint();
...
//! Load a PGM greyscale image as a matrix
template <typename T>
inline bool diskio::load_pgm_binary(Mat<std::complex<T> >& x, std::istream& is,
                                    std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_hdf5_binary(Mat<eT>& x, const hdf5_name& spec,
                                     std::string& err_msg) {
  arma_debug_sigprint();

#if defined(ARMA_USE_HDF5)
  {
    if (diskio::is_readable(spec.filename) == false) {
      return false;
    }
    ...
    if (fid >= 0) {
      ...
      // Octave tends to store the datasets in a group, with the actual dataset being
      // referred to as "value". If the user hasn't specified a dataset, we will search
      // for "dataset" and "value", and if those are not found we will take the first
      // dataset we do find.
      ...
      if (dataset >= 0) {
        ...
        if (H5Tequal(datatype, mat_type) > 0) {
          ...
          hid_t read_status = H5Dread(dataset, datatype, H5S_ALL, H5S_ALL, H5P_DEFAULT,
                                      void_ptr(x.memptr()));
          ...
          hid_t read_status =
              hdf5_misc::load_and_convert_hdf5(x.memptr(), dataset, datatype, x.n_elem);
...
template <typename eT>
inline bool diskio::load_auto_detect(Mat<eT>& x, const std::string& name,
                                     std::string& err_msg) {
  arma_debug_sigprint();

  if (diskio::is_readable(name) == false) {
    return false;
  }

#if defined(ARMA_USE_HDF5)
  // We're currently using the C bindings for the HDF5 library, which don't support C++
  // streams
...
//! Try to load a matrix by automatically determining its type
template <typename eT>
inline bool diskio::load_auto_detect(Mat<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
  ...
  } else if (std::strncmp(ARMA_MAT_BIN_str, header_mem, size_t(ARMA_MAT_BIN_len)) == 0) {
    return load_arma_binary(x, f, err_msg);
  } else if (std::strncmp(P5_str, header_mem, size_t(P5_len)) == 0) {
...
template <typename eT>
inline bool diskio::save_csv_ascii(const SpMat<eT>& x, const std::string& final_name,
                                   const field<std::string>& header,
                                   const bool with_header, const char separator) {
  arma_debug_sigprint();
...
//! Save a sparse matrix in CSV format
template <typename eT>
inline bool diskio::save_csv_ascii(const SpMat<eT>& x, std::ostream& f,
                                   const char separator) {
  arma_debug_sigprint();
...
template <typename T>
inline bool diskio::save_csv_ascii(const SpMat<std::complex<T> >& x, std::ostream& f,
                                   const char separator) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_coord_ascii(const SpMat<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
//! Save a matrix in ASCII coord format
template <typename eT>
inline bool diskio::save_coord_ascii(const SpMat<eT>& x, std::ostream& f) {
  arma_debug_sigprint();
...
//! with a header that stores the matrix type as well as its dimensions
template <typename eT>
inline bool diskio::save_arma_binary(const SpMat<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
//! with a header that stores the matrix type as well as its dimensions
template <typename eT>
inline bool diskio::save_arma_binary(const SpMat<eT>& x, std::ostream& f) {
  arma_debug_sigprint();

  f << diskio::gen_bin_header(x) << '\n';
  f << x.n_rows << ' ' << x.n_cols << ' ' << x.n_nonzero << '\n';

  f.write(reinterpret_cast<const char*>(x.values),
...
template <typename eT>
inline bool diskio::load_csv_ascii(SpMat<eT>& x, const std::string& name,
                                   std::string& err_msg, field<std::string>& header,
                                   const bool with_header, const char separator) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_csv_ascii(SpMat<eT>& x, std::istream& f, std::string& err_msg,
                                   const char separator) {
  arma_debug_sigprint();
...
template <typename T>
inline bool diskio::load_csv_ascii(SpMat<std::complex<T> >& x, std::istream& f,
                                   std::string& err_msg, const char separator) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_coord_ascii(SpMat<eT>& x, const std::string& name,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_coord_ascii(SpMat<eT>& x, std::istream& f,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename T>
inline bool diskio::load_coord_ascii(SpMat<std::complex<T> >& x, std::istream& f,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
//! with a header that indicates the matrix type as well as its dimensions
template <typename eT>
inline bool diskio::load_arma_binary(SpMat<eT>& x, const std::string& name,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_arma_binary(SpMat<eT>& x, std::istream& f,
                                     std::string& err_msg) {
  arma_debug_sigprint();
  ...
  if (f_header == diskio::gen_bin_header(x)) {
    ...
    f.read(reinterpret_cast<char*>(access::rwp(x.row_indices)),
           std::streamsize(x.n_nonzero * sizeof(uword)));
    f.read(reinterpret_cast<char*>(access::rwp(x.col_ptrs)),
           std::streamsize((x.n_cols + 1) * sizeof(uword)));
    ...
    if ((check1 == true) && ((check2 == false) || (check3 == false))) {
      if (sizeof(uword) == 8) {
        arma_debug_print(
            "detected inconsistent data while loading; re-reading integer parts as u32");

        // inconstency could be due to a different uword size used during saving,
        // so try loading the row_indices and col_ptrs under the assumption of 32 bit
        // unsigned integers
        ...
        f.read(reinterpret_cast<char*>(tmp_a.memptr()),
               std::streamsize(x.n_nonzero * sizeof(u32)));
        f.read(reinterpret_cast<char*>(tmp_b.memptr()),
               std::streamsize((x.n_cols + 1) * sizeof(u32)));
...
template <typename eT>
inline bool diskio::save_raw_ascii(const Cube<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
//! Save a cube as raw text (no header, human readable).
template <typename eT>
inline bool diskio::save_raw_ascii(const Cube<eT>& x, std::ostream& f) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_raw_binary(const Cube<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_raw_binary(const Cube<eT>& x, std::ostream& f) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_arma_ascii(const Cube<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
//! with a header that indicates the cube type as well as its dimensions
template <typename eT>
inline bool diskio::save_arma_ascii(const Cube<eT>& x, std::ostream& f) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_arma_binary(const Cube<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
//! with a header that stores the cube type as well as its dimensions
template <typename eT>
inline bool diskio::save_arma_binary(const Cube<eT>& x, std::ostream& f) {
  arma_debug_sigprint();
...
inline bool diskio::save_hdf5_binary(const Cube<eT>& x, const hdf5_name& spec,
...
#if defined(ARMA_USE_HDF5)
  {
    ...
    hid_t dataspace =
        H5Screate_simple(3, dims, NULL);  // treat the cube as a 3d array dataspace
    hid_t datatype = hdf5_misc::get_hdf5_type<eT>();
...
//! NOTE: this is much slower than reading a file with a header.
template <typename eT>
inline bool diskio::load_raw_ascii(Cube<eT>& x, const std::string& name,
                                   std::string& err_msg) {
  arma_debug_sigprint();
...
//! NOTE: this is much slower than reading a file with a header.
template <typename eT>
inline bool diskio::load_raw_ascii(Cube<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_raw_binary(Cube<eT>& x, const std::string& name,
                                    std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_raw_binary(Cube<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
...
//! with a header that indicates the cube type as well as its dimensions
template <typename eT>
inline bool diskio::load_arma_ascii(Cube<eT>& x, const std::string& name,
                                    std::string& err_msg) {
  arma_debug_sigprint();
...
//! with a header that indicates the cube type as well as its dimensions
template <typename eT>
inline bool diskio::load_arma_ascii(Cube<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
...
//! with a header that indicates the cube type as well as its dimensions
template <typename eT>
inline bool diskio::load_arma_binary(Cube<eT>& x, const std::string& name,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_arma_binary(Cube<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_hdf5_binary(Cube<eT>& x, const hdf5_name& spec,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_auto_detect(Cube<eT>& x, const std::string& name,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
//! Try to load a cube by automatically determining its type
template <typename eT>
inline bool diskio::load_auto_detect(Cube<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
  ...
  if (std::strncmp(ARMA_CUB_TXT_str, header_mem, size_t(ARMA_CUB_TXT_len)) == 0) {
    return load_arma_ascii(x, f, err_msg);
  } else if (std::strncmp(ARMA_CUB_BIN_str, header_mem, size_t(ARMA_CUB_BIN_len)) == 0) {
    return load_arma_binary(x, f, err_msg);
  } else if (std::strncmp(P6_str, header_mem, size_t(P6_len)) == 0) {
...
inline bool diskio::save_arma_binary(const field<T1>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
template <typename T1>
inline bool diskio::save_arma_binary(const field<T1>& x, std::ostream& f) {
  arma_debug_sigprint();
...
template <typename T1>
inline bool diskio::load_arma_binary(field<T1>& x, const std::string& name,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename T1>
inline bool diskio::load_arma_binary(field<T1>& x, std::istream& f,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
inline bool diskio::save_std_string(const field<std::string>& x,
                                    const std::string& final_name) {
  arma_debug_sigprint();
...
inline bool diskio::save_std_string(const field<std::string>& x, std::ostream& f) {
  arma_debug_sigprint();
...
inline bool diskio::load_std_string(field<std::string>& x, const std::string& name,
                                    std::string& err_msg) {
  arma_debug_sigprint();
...
inline bool diskio::load_std_string(field<std::string>& x, std::istream& f,
                                    std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename T1>
inline bool diskio::load_auto_detect(field<T1>& x, const std::string& name,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
//! Try to load a field by automatically determining its type
template <typename T1>
inline bool diskio::load_auto_detect(field<T1>& x, std::istream& f,
                                     std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_ppm_binary(Cube<eT>& x, const std::string& name,
                                    std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::load_ppm_binary(Cube<eT>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_ppm_binary(const Cube<eT>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
template <typename eT>
inline bool diskio::save_ppm_binary(const Cube<eT>& x, std::ostream& f) {
  arma_debug_sigprint();

  arma_conform_check((x.n_slices != 3),
                     "diskio::save_ppm_binary(): given cube must have exactly 3 slices");
...
template <typename T1>
inline bool diskio::load_ppm_binary(field<T1>& x, const std::string& name,
                                    std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename T1>
inline bool diskio::load_ppm_binary(field<T1>& x, std::istream& f, std::string& err_msg) {
  arma_debug_sigprint();
...
template <typename T1>
inline bool diskio::save_ppm_binary(const field<T1>& x, const std::string& final_name) {
  arma_debug_sigprint();
...
template <typename T1>
inline bool diskio::save_ppm_binary(const field<T1>& x, std::ostream& f) {
  arma_debug_sigprint();
  ...
  arma_conform_check((x.n_elem != 3),
                     "diskio::save_ppm_binary(): given field must have exactly 3 "
  ...
  arma_conform_check((same_size != true),
                     "diskio::save_ppm_binary(): given field must have exactly 3 "
                     "matrices of equal size");
