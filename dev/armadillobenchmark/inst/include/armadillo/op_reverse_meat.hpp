...
inline void op_reverse::apply(Mat<typename T1::elem_type>& out,
                              const Op<T1, op_reverse>& in) {
  arma_debug_sigprint();
...
template <typename T1>
inline void op_reverse_vec::apply(Mat<typename T1::elem_type>& out,
                                  const Op<T1, op_reverse_vec>& in) {
  arma_debug_sigprint();
