...
class glue_rel_lt : public traits_glue_or {
 public:
...
class glue_rel_gt : public traits_glue_or {
 public:
  template <typename T1, typename T2>
...
class glue_rel_lteq : public traits_glue_or {
 public:
  template <typename T1, typename T2>
...
class glue_rel_gteq : public traits_glue_or {
 public:
  template <typename T1, typename T2>
  inline static void apply(Mat<uword>& out,
...
class glue_rel_eq : public traits_glue_or {
 public:
  template <typename T1, typename T2>
...
class glue_rel_noteq : public traits_glue_or {
 public:
  template <typename T1, typename T2>
  inline static void apply(Mat<uword>& out,
...
class glue_rel_and : public traits_glue_or {
 public:
  template <typename T1, typename T2>
...
class glue_rel_or : public traits_glue_or {
 public:
  template <typename T1, typename T2>
