...
inline void op_max::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_max>& in) {
  arma_debug_sigprint();
...
inline void op_max::apply_noalias(Mat<eT>& out, const Mat<eT>& X, const uword dim,
...
template <typename T1>
inline void op_max::apply(Cube<typename T1::elem_type>& out,
                          const OpCube<T1, op_max>& in) {
  arma_debug_sigprint();
...
template <typename eT>
inline void op_max::apply_noalias(Cube<eT>& out, const Cube<eT>& X, const uword dim,
                                  const typename arma_not_cx<eT>::result* junk) {
  arma_debug_sigprint();
  arma_ignore(junk);
...
template <typename eT>
inline eT op_max::direct_max(const eT* const X, const uword n_elem) {
  arma_debug_sigprint();
...
template <typename eT>
inline eT op_max::direct_max(const Mat<eT>& X, const uword row) {
  arma_debug_sigprint();
...
template <typename eT>
inline eT op_max::max(const subview<eT>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline typename arma_not_cx<typename T1::elem_type>::result op_max::max(
...
template <typename T1>
inline typename arma_not_cx<typename T1::elem_type>::result op_max::max_with_index(
    const Proxy<T1>& P, uword& index_of_max_val) {
  arma_debug_sigprint();
...
template <typename T1>
inline typename arma_not_cx<typename T1::elem_type>::result op_max::max_with_index(
    const ProxyCube<T1>& P, uword& index_of_max_val) {
  arma_debug_sigprint();
...
template <typename T>
inline std::complex<T> op_max::direct_max(const std::complex<T>* const X,
                                          const uword n_elem) {
  arma_debug_sigprint();
...
template <typename T>
inline std::complex<T> op_max::direct_max(const std::complex<T>* const X,
                                          const uword n_elem, uword& index_of_max_val) {
  arma_debug_sigprint();
...
template <typename T>
inline std::complex<T> op_max::direct_max(const Mat<std::complex<T> >& X,
                                          const uword row) {
  arma_debug_sigprint();
...
template <typename T>
inline std::complex<T> op_max::max(const subview<std::complex<T> >& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline typename arma_cx_only<typename T1::elem_type>::result op_max::max(
    const Base<typename T1::elem_type, T1>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline typename arma_cx_only<typename T1::elem_type>::result op_max::max_with_index(
    const Proxy<T1>& P, uword& index_of_max_val) {
  arma_debug_sigprint();
