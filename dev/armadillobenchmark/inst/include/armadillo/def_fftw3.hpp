...
fftwf_plan fftwf_plan_dft_1d(int N, fftwf_complex* input, fftwf_complex* output,
                             int fftw3_sign, unsigned int fftw3_flags);
...
fftw_plan fftw_plan_dft_1d(int N, fftw_complex* input, fftw_complex* output,
                           int fftw3_sign, unsigned int fftw3_flags);
