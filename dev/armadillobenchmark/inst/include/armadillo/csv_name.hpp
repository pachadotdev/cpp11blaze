...
inline constexpr opts::opts(const flag_type in_flags) : flags(in_flags) {}
...
struct opts_trans : public opts {
  inline constexpr opts_trans() : opts(flag_trans) {}
};
struct opts_no_header : public opts {
  inline constexpr opts_no_header() : opts(flag_no_header) {}
};
struct opts_with_header : public opts {
  inline constexpr opts_with_header() : opts(flag_with_header) {}
};
struct opts_semicolon : public opts {
  inline constexpr opts_semicolon() : opts(flag_semicolon) {}
};
struct opts_strict : public opts {
  inline constexpr opts_strict() : opts(flag_strict) {}
};
...
struct csv_name {
  ...
  inline csv_name(const std::string& in_filename)
      : filename(in_filename),
        opts(csv_opts::no_header),
        header_ro(header_junk),
        header_rw(header_junk) {}

  inline csv_name(const std::string& in_filename, const csv_opts::opts& in_opts)
      : filename(in_filename),
