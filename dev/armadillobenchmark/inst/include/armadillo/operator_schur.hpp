...
//! optimization: sparse % (sparse +/- scalar) can be done without forming the dense
//! result of the (sparse +/- scalar) term
...
//! optimization: (sparse +/- scalar) % sparse can be done without forming the dense
//! result of the (sparse +/- scalar) term
template <typename T1, typename T2, typename op_type>
inline typename enable_if2<
    (is_arma_sparse_type<T1>::value && is_arma_sparse_type<T2>::value &&
...
//! element-wise multiplication of one dense and one sparse object with different element
//! types
template <typename T1, typename T2>
inline typename enable_if2<
    (is_arma_type<T1>::value && is_arma_sparse_type<T2>::value &&
...
//! element-wise multiplication of one sparse and one dense object with different element
//! types
template <typename T1, typename T2>
inline typename enable_if2<
    (is_arma_sparse_type<T1>::value && is_arma_type<T2>::value &&
