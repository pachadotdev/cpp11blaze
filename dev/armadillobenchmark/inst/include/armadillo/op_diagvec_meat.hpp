...
template <typename T1>
inline void op_diagvec::apply_proxy(Mat<typename T1::elem_type>& out,
                                    const Proxy<T1>& P) {
  arma_debug_sigprint();
...
inline void op_diagvec::apply(
    Mat<typename T1::elem_type>& actual_out,
    const Op<Glue<T1, T2, glue_times>, op_diagvec>& X,
...
template <typename T1>
inline void op_diagvec2::apply(Mat<typename T1::elem_type>& out,
                               const Op<T1, op_diagvec2>& X) {
  arma_debug_sigprint();
...
template <typename T1>
inline void op_diagvec2::apply_proxy(Mat<typename T1::elem_type>& out, const Proxy<T1>& P,
