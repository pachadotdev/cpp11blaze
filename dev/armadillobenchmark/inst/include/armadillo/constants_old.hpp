...
class Math {
 public:
  ...
  arma_frown("use datum::euler instead") static eT euler() {
    return eT(Datum<eT>::euler);
  }
  arma_frown("use datum::gratio instead") static eT gratio() {
    return eT(Datum<eT>::gratio);
  }
  arma_frown("use datum::sqrt2 instead") static eT sqrt2() {
    return eT(Datum<eT>::sqrt2);
  }
  arma_frown("use datum::eps instead") static eT eps() { return eT(Datum<eT>::eps); }
  arma_frown("use datum::log_min instead") static eT log_min() {
    return eT(Datum<eT>::log_min);
  }
  arma_frown("use datum::log_max instead") static eT log_max() {
    return eT(Datum<eT>::log_max);
  }
