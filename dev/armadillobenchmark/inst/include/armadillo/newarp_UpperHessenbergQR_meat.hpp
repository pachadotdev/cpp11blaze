...
inline UpperHessenbergQR<eT>::UpperHessenbergQR() : n(0), computed(false) {
  arma_debug_sigprint();
}
...
Mat<eT> UpperHessenbergQR<eT>::matrix_RQ() {
  ...
  arma_conform_check(
      (computed == false),
      "newarp::UpperHessenbergQR::matrix_RQ(): need to call compute() first");
...
inline void UpperHessenbergQR<eT>::apply_YQ(Mat<eT>& Y) {
  ...
  arma_conform_check(
      (computed == false),
      "newarp::UpperHessenbergQR::apply_YQ(): need to call compute() first");
...
template <typename eT>
inline TridiagQR<eT>::TridiagQR() : UpperHessenbergQR<eT>() {
  arma_debug_sigprint();
}

template <typename eT>
inline TridiagQR<eT>::TridiagQR(const Mat<eT>& mat_obj) : UpperHessenbergQR<eT>() {
  arma_debug_sigprint();
...
Mat<eT> TridiagQR<eT>::matrix_RQ() {
  ...
  arma_conform_check((this->computed == false),
                     "newarp::TridiagQR::matrix_RQ(): need to call compute() first");
