...
arma_warn_unused inline Mat<eT> join_cols(const Base<eT, T1>& A, const Base<eT, T2>& B,
                                          const Base<eT, T3>& C) {
  arma_debug_sigprint();
...
arma_warn_unused inline Mat<eT> join_cols(const Base<eT, T1>& A, const Base<eT, T2>& B,
                                          const Base<eT, T3>& C, const Base<eT, T4>& D) {
  arma_debug_sigprint();
...
template <typename eT, typename T1, typename T2, typename T3>
arma_warn_unused inline Mat<eT> join_vert(const Base<eT, T1>& A, const Base<eT, T2>& B,
                                          const Base<eT, T3>& C) {
  arma_debug_sigprint();
...
template <typename eT, typename T1, typename T2, typename T3>
arma_warn_unused inline Mat<eT> join_rows(const Base<eT, T1>& A, const Base<eT, T2>& B,
                                          const Base<eT, T3>& C) {
  arma_debug_sigprint();
...
template <typename eT, typename T1, typename T2, typename T3>
arma_warn_unused inline Mat<eT> join_horiz(const Base<eT, T1>& A, const Base<eT, T2>& B,
                                           const Base<eT, T3>& C) {
  arma_debug_sigprint();
...
template <typename T1, typename T2>
arma_warn_unused inline const GlueCube<T1, T2, glue_join_slices> join_slices(
...
template <typename T1, typename T2>
arma_warn_unused inline Cube<typename T1::elem_type> join_slices(
  ...
  arma_conform_assert_same_size(UA.M.n_rows, UA.M.n_cols, UB.M.n_rows, UB.M.n_cols,
                                "join_slices(): incompatible dimensions");
...
template <typename T1, typename T2>
arma_warn_unused inline const SpGlue<T1, T2, spglue_join_cols> join_cols(
...
template <typename eT, typename T1, typename T2, typename T3>
arma_warn_unused inline SpMat<eT> join_cols(const SpBase<eT, T1>& A,
                                            const SpBase<eT, T2>& B,
                                            const SpBase<eT, T3>& C) {
  arma_debug_sigprint();
...
template <typename T1, typename T2>
arma_warn_unused inline const SpGlue<T1, T2, spglue_join_cols> join_vert(
    const SpBase<typename T1::elem_type, T1>& A,
    const SpBase<typename T1::elem_type, T2>& B) {
  arma_debug_sigprint();
...
template <typename eT, typename T1, typename T2, typename T3>
arma_warn_unused inline SpMat<eT> join_vert(const SpBase<eT, T1>& A,
                                            const SpBase<eT, T2>& B,
                                            const SpBase<eT, T3>& C) {
  arma_debug_sigprint();
...
template <typename T1, typename T2>
arma_warn_unused inline const SpGlue<T1, T2, spglue_join_rows> join_rows(
    const SpBase<typename T1::elem_type, T1>& A,
    const SpBase<typename T1::elem_type, T2>& B) {
  arma_debug_sigprint();
...
template <typename eT, typename T1, typename T2, typename T3>
arma_warn_unused inline SpMat<eT> join_rows(const SpBase<eT, T1>& A,
                                            const SpBase<eT, T2>& B,
                                            const SpBase<eT, T3>& C) {
  arma_debug_sigprint();
...
template <typename T1, typename T2>
arma_warn_unused inline const SpGlue<T1, T2, spglue_join_rows> join_horiz(
    const SpBase<typename T1::elem_type, T1>& A,
    const SpBase<typename T1::elem_type, T2>& B) {
  arma_debug_sigprint();
...
template <typename eT, typename T1, typename T2, typename T3>
arma_warn_unused inline SpMat<eT> join_horiz(const SpBase<eT, T1>& A,
                                             const SpBase<eT, T2>& B,
                                             const SpBase<eT, T3>& C) {
  arma_debug_sigprint();
