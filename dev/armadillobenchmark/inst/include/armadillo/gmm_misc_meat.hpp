...
template <typename eT>
arma_inline eT distance<eT, uword(1)>::eval(const uword N, const eT* A, const eT* B,
                                            const eT*) {
  eT acc1 = eT(0);
  eT acc2 = eT(0);
...
template <typename eT>
arma_inline eT distance<eT, uword(2)>::eval(const uword N, const eT* A, const eT* B,
                                            const eT* C) {
  eT acc1 = eT(0);
  eT acc2 = eT(0);
