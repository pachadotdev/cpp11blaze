...
template <typename T1>
arma_warn_unused arma_inline const T1& real(
...
template <typename T1>
arma_warn_unused arma_inline const T1& real(const SpBase<typename T1::pod_type, T1>& A) {
  arma_debug_sigprint();
...
arma_warn_unused inline
    typename enable_if2<(is_arma_type<T1>::value && is_cx<typename T1::elem_type>::yes),
                        const mtOp<typename T1::pod_type, T1, op_real> >::result
    real(const T1& X) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused inline const mtOpCube<typename T1::pod_type, T1, op_real> real(
...
template <typename T1>
arma_warn_unused arma_inline const mtSpOp<typename T1::pod_type, T1, spop_real> real(
    const SpBase<std::complex<typename T1::pod_type>, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused inline const Gen<Mat<typename T1::pod_type>, gen_zeros> imag(
...
template <typename T1>
arma_warn_unused inline const GenCube<typename T1::pod_type, gen_zeros> imag(
    const BaseCube<typename T1::pod_type, T1>& X) {
  arma_debug_sigprint();

  const ProxyCube<T1> A(X.get_ref());

  return GenCube<typename T1::pod_type, gen_zeros>(A.get_n_rows(), A.get_n_cols(),
                                                   A.get_n_slices());
}

template <typename T1>
arma_warn_unused inline SpMat<typename T1::pod_type> imag(
    const SpBase<typename T1::pod_type, T1>& A) {
  arma_debug_sigprint();
...
arma_warn_unused inline
    typename enable_if2<(is_arma_type<T1>::value && is_cx<typename T1::elem_type>::yes),
                        const mtOp<typename T1::pod_type, T1, op_imag> >::result
    imag(const T1& X) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused inline const mtOpCube<typename T1::pod_type, T1, op_imag> imag(
    const BaseCube<std::complex<typename T1::pod_type>, T1>& X) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const mtSpOp<typename T1::pod_type, T1, spop_imag> imag(
    const SpBase<std::complex<typename T1::pod_type>, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_log> log(
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_log2> log2(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_log10> log10(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
arma_warn_unused arma_inline typename enable_if2<is_cx<typename T1::elem_type>::no,
                                                 const eOpCube<T1, eop_log1p> >::result
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_exp> exp(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_exp2> exp2(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_exp10> exp10(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline typename enable_if2<is_cx<typename T1::elem_type>::no,
                                                 const eOpCube<T1, eop_expm1> >::result
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_abs> abs(
    const BaseCube<typename T1::elem_type, T1>& X,
    const typename arma_not_cx<typename T1::elem_type>::result* junk = nullptr) {
  arma_debug_sigprint();
...
arma_warn_unused inline
    typename enable_if2<(is_arma_type<T1>::value && is_cx<typename T1::elem_type>::yes),
                        const mtOp<typename T1::pod_type, T1, op_abs> >::result
    abs(const T1& X) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused inline const mtOpCube<typename T1::pod_type, T1, op_abs> abs(
    const BaseCube<std::complex<typename T1::pod_type>, T1>& X,
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_abs> abs(
...
template <typename T1>
arma_warn_unused arma_inline const mtSpOp<typename T1::pod_type, T1, spop_cx_abs> abs(
    const SpBase<std::complex<typename T1::pod_type>, T1>& X,
    const typename arma_cx_only<typename T1::elem_type>::result* junk = nullptr) {
  arma_debug_sigprint();
  arma_ignore(junk);
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_arg> arg(
    const BaseCube<typename T1::elem_type, T1>& X,
    const typename arma_not_cx<typename T1::elem_type>::result* junk = nullptr) {
  arma_debug_sigprint();
...
arma_warn_unused inline
    typename enable_if2<(is_arma_type<T1>::value && is_cx<typename T1::elem_type>::yes),
                        const mtOp<typename T1::pod_type, T1, op_arg> >::result
    arg(const T1& X) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused inline const mtOpCube<typename T1::pod_type, T1, op_arg> arg(
    const BaseCube<std::complex<typename T1::pod_type>, T1>& X,
    const typename arma_cx_only<typename T1::elem_type>::result* junk = nullptr) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_arg> arg(
    const SpBase<typename T1::elem_type, T1>& X,
    const typename arma_not_cx<typename T1::elem_type>::result* junk = nullptr) {
  arma_debug_sigprint();
  arma_ignore(junk);
...
template <typename T1>
arma_warn_unused arma_inline const mtSpOp<typename T1::pod_type, T1, spop_cx_arg> arg(
    const SpBase<std::complex<typename T1::pod_type>, T1>& X,
    const typename arma_cx_only<typename T1::elem_type>::result* junk = nullptr) {
  arma_debug_sigprint();
  arma_ignore(junk);
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_square> square(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_square> square(
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_sqrt> sqrt(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_sqrt> sqrt(
    const SpBase<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline typename enable_if2<is_cx<typename T1::elem_type>::no,
                                                 const eOpCube<T1, eop_cbrt> >::result
...
template <typename T1>
arma_warn_unused arma_inline typename enable_if2<is_cx<typename T1::elem_type>::no,
                                                 const SpOp<T1, spop_cbrt> >::result
...
template <typename T1>
arma_warn_unused arma_inline const T1& conj(const Base<typename T1::pod_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const T1& conj(
    const BaseCube<typename T1::pod_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const T1& conj(const SpBase<typename T1::pod_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOp<T1, eop_conj> conj(
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_conj> conj(
    const BaseCube<std::complex<typename T1::pod_type>, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_conj> conj(
    const SpBase<std::complex<typename T1::pod_type>, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOp<T1, eop_pow> pow(
    const Base<typename T1::elem_type, T1>& A, const typename T1::elem_type exponent) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_pow> pow(
    const BaseCube<typename T1::elem_type, T1>& A,
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_floor> floor(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_floor> floor(
    const SpBase<typename T1::elem_type, T1>& X) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_ceil> ceil(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_ceil> ceil(
    const SpBase<typename T1::elem_type, T1>& X) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_round> round(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_round> round(
    const SpBase<typename T1::elem_type, T1>& X) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_trunc> trunc(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_trunc> trunc(
    const SpBase<typename T1::elem_type, T1>& X) {
  arma_debug_sigprint();
...
arma_warn_unused arma_inline typename arma_scalar_only<eT>::result sign(const eT x) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const eOpCube<T1, eop_sign> sign(
    const BaseCube<typename T1::elem_type, T1>& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline const SpOp<T1, spop_sign> sign(
    const SpBase<typename T1::elem_type, T1>& X) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline typename enable_if2<is_cx<typename T1::elem_type>::no,
                                                 const eOpCube<T1, eop_erf> >::result
...
template <typename T1>
arma_warn_unused arma_inline typename enable_if2<is_cx<typename T1::elem_type>::no,
                                                 const eOpCube<T1, eop_erfc> >::result
...
arma_warn_unused arma_inline
    typename enable_if2<(is_arma_type<T1>::value && is_cx<typename T1::elem_type>::no),
                        const eOp<T1, eop_lgamma> >::result
    lgamma(const T1& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline typename enable_if2<is_cx<typename T1::elem_type>::no,
                                                 const eOpCube<T1, eop_lgamma> >::result
...
arma_warn_unused arma_inline
    typename enable_if2<(is_arma_type<T1>::value && is_cx<typename T1::elem_type>::no),
                        const eOp<T1, eop_tgamma> >::result
    tgamma(const T1& A) {
  arma_debug_sigprint();
...
template <typename T1>
arma_warn_unused arma_inline typename enable_if2<is_cx<typename T1::elem_type>::no,
                                                 const eOpCube<T1, eop_tgamma> >::result
...
template <typename T1>
void exp_approx(const T1&) {
  arma_stop_logic_error("unimplemented");
}
template <typename T1>
void log_approx(const T1&) {
  arma_stop_logic_error("unimplemented");
}
template <typename T1>
void approx_exp(const T1&) {
  arma_stop_logic_error("unimplemented");
}
template <typename T1>
void approx_log(const T1&) {
  arma_stop_logic_error("unimplemented");
}
