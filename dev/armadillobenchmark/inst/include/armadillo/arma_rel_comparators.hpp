...
struct arma_lt_comparator<std::complex<T> > {
  ...
  //
  //   if( (a_mag_squared != T(0)) && (b_mag_squared != T(0)) &&
  //   std::isfinite(a_mag_squared) && std::isfinite(b_mag_squared) )
  //     {
  //     return ( (a_mag_squared != b_mag_squared) ? (a_mag_squared < b_mag_squared) :
  //     (std::arg(a) < std::arg(b)) );
  //     }
  //   else
  //     {
