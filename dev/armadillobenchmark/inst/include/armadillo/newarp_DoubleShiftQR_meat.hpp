...
inline void DoubleShiftQR<eT>::compute_reflector(const eT& x1, const eT& x2, const eT& x3,
                                                 uword ind) {
  arma_debug_sigprint();
...
template <typename eT>
inline void DoubleShiftQR<eT>::apply_PX(Mat<eT>& X, uword oi, uword oj, uword nrow,
                                        uword ncol, uword u_ind) {
  arma_debug_sigprint();
...
template <typename eT>
inline void DoubleShiftQR<eT>::apply_XP(Mat<eT>& X, uword oi, uword oj, uword nrow,
                                        uword ncol, uword u_ind) {
  arma_debug_sigprint();
...
inline void DoubleShiftQR<eT>::apply_QtY(Col<eT>& y) {
  ...
  arma_conform_check((computed == false),
